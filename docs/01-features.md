...
简体中文 | [English](./01-features.en.md)

> 从一个俄罗斯方块，到一套现代 JavaScript 游戏运行时。

## 一个不断演进的项目

tetris.js 最初只是一个使用 JavaScript 与 HTML5
Canvas 编写的俄罗斯方块。随着项目不断迭代，它逐渐拥有了越来越多的能力。Replay、AI、Battle、Scheduler、Command、Game
Runtime……，这些能力并不是最初就规划好的目标。它们都是在解决真实问题的过程中，一步一步演进出来的。

![俄罗斯方块游戏-功能特性](assets/img/features-poster.png)
...
> 深入阅读：[03-runtime.md](./03-runtime.md)
...
> 深入阅读：[05-replay.md](./05-replay.md)
...
> 深入阅读：[06-battle.md](./06-battle.md)
...
因此，游戏逻辑完全无需关心输入来源。未来新增新的输入设备，通常只需要增加一个新的 Input
Adapter。
...
如果你已经了解了 tetris.js 的整体能力。下一章将介绍整个项目最核心的话题：**Architecture**。它将解释：

- 为什么这些系统能够共享同一套 Runtime？
- 整个架构是如何一步一步演进到今天这个样子的？

**下一章：[02-architecture.md](./02-architecture.md)**
