...
- 游戏音效：
  ...
  - 背景音乐开/关音效；
  - 背景音乐；
    - TetrisTheme：游戏等级 1-3 级时播放；
    - Loginska：游戏等级 4-6 级时播放；
    - Technotris：游戏等级 7-9 级时播放；
    - FirstDivision：游戏等级 10-12 级时播放；
    - Korobeiniki：游戏等级 13-15 级时播放；
    - JourneyToWest：游戏等级 15 级以上时播放；
- 游戏界面：自适应浏览器窗口大小
