...
- **计分感知**：T-Spin、Back-to-Back、All
  Clear、Combo 等高级计分规则全部纳入评估

### 难度梯度

| 难度 | 预判深度 | 失误率 | 延迟  | 说明               |
| ---- | -------- | ------ | ----- | ------------------ |
| 简单 | 2 步     | 25%    | 580ms | 偶尔犯错，反应较慢 |
| 普通 | 3 步     | 15%    | 480ms | 偶尔失误，中等速度 |
| 困难 | 4 步     | 5%     | 280ms | 很少犯错，较快响应 |
| 专家 | 4 步     | 0%     | 150ms | 从不犯错，极限反应 |
