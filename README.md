...
- 游戏音效：
  ...
  - 背景音乐开/关音效；
  - 背景音乐；
    - TetrisTheme：游戏等级 1-12 级时播放；
    - JasmineFlower：游戏等级 13-24 级时播放；
    - FirstDivision：游戏等级 25-36 级时播放；
    - Loginska：游戏等级 37-48 级时播放；
    - Technotris：游戏等级 49-60 级时播放；
    - Korobeiniki：游戏等级 61 - 72 级时播放；
    - BeyondTheWall：游戏等级 73 - 84 级时播放（危险了！）；
    - JourneyToWest：游戏等级 84 级以上时播放（大圣！！！）；
- 游戏界面：自适应浏览器窗口大小
