import { BOARD_COLS, BOARD_ROWS, TETROMINOES } from './constants.js';
...
import { playBGM, stopBGM, sounds } from './audio.js';
 ...
 * 只有达到指定时间间隔才执行下落逻辑
 *
 * @function gameSpeedLoop
 * @param {number} timestamp - 时间戳数值
 * @returns {void}
 */
export const gameSpeedLoop = (timestamp) => {
  // 获取当前等级的下落间隔（毫秒）
