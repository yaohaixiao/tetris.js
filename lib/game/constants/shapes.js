 ...
 * @property {number[][]} shape - 方块形状矩阵
 * @property {number} colorIndex - 配色方案中的索引（0-7）
 * @property {string} type - 方块类型标识
 * @property {number} rotation - 初始旋转状态
 */
