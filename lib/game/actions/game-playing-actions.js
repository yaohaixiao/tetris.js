...
const GAME_PLAYING_ACTIONS = {
  ...
  MOVE_LEFT: (payload) => {
    ...
    Game.emit(`game:${Game.id}:block:move`, {
      ox: -1,
      oy: 0,
    });
  },
  ...
  ROTATE: (payload) => {
    ...
    Game.emit(`game:${Game.id}:block:rotate`);
  },
  ...
  DROP: (payload) => {
    ...
    Game.emit(`game:${Game.id}:block:drop`);
  },
  ...
  RESTART: (payload) => {
    ...
    Game.emit(`game:${Game.id}:restart`);
  },
  ...
  TOGGLE_MUSIC: (payload) => {
    ...
    Game.emit(`game:${Game.id}:toggle:bgm`);
  },
  ...
  SWITCH_CONTROLLER: (payload) => {
    ...
    Game.emit(`game:${Game.id}:swtich:controller`);
  },
};
