 ...
 *
 * 为每位玩家生成完整的游戏界面，包含棋盘 Canvas、HUD 数据面板、 预览/缓存方块 Canvas 和 GAME BOY 风格的触屏控制按钮。
 *
 * ## 生成的 DOM 结构
 *
 ...
 *
 * @example
 *   getGameInterfaceTemplate(Elements, 'human', 0);
 *   // → P1 的完整游戏界面 HTML
 *
 *   getGameInterfaceTemplate(Elements, 'human', 1);
 *   // → P2 的完整游戏界面 HTML
 *
