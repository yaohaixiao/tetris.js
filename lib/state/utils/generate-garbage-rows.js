 ...
 *
 * 1. 每行先用随机颜色填满所有格子
 * 2. 随机挖掉 1 ~ (cols - 3) 个格子（至少保留 3 个）
 * 3. 保证不会出现完全填满的行，避免开局就消行
 *
 * ## 安全说明
 *
 * 使用 Math.random() 生成颜色和空洞位置， 仅用于游戏视觉表现，非安全上下文，可接受。
 *
 * ## 难度对应
 *
 * | 难度   | 垃圾行数 |
