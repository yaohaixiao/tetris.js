...
import renderChineseHourCharacter from '../image/render-chinese-hour-character.js';
...
export function renderBoard(board) {
  ...
  // 绘制12时辰文字
  renderChineseHourCharacter();

  // 绘制背景图案
  renderSceneBackground('playing');
