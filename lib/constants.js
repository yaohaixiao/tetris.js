...
/* -------- 游戏面板中使用的颜色 -------- */
// 青色
export const COLOR_TEAL = '#18c8fa';
// 青色半透明
export const COLOR_RGBA_TEAL = 'rgba(50, 190, 239, 0.3)';
// 黄色
...
// 橙色
export const COLOR_ORANGE = '#ff7f00'; // '#ff9800';
// 绿色
...
export const COLOR_RGBA_BLACK = 'rgba(0,0,0,.5)';
// 白色
...
export const GAME_FONT_FAMILY = `"Press Start 2P", monospace, sans-serif`;
