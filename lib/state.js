 ...
 * @property {number | null} gameRafId - 游戏动画Id
 * @property {number | null} gameTimestamp - 游戏动画时间戳
 * @property {object | null} countdown - 倒计时信息对象
 * @property {object} clock - 暂停时钟信息对象
 ...
 * @property {number | null} clearEffectsRafId - 消除层特效动画Id
 * @property {object[]} clearEffects - 消除层特效信息数组对象
