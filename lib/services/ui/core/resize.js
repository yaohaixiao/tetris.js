 ...
 * @param {HTMLCanvasElement} canvas.gameBoard - 主棋盘 Canvas
 * @param {HTMLCanvasElement} canvas.nextPiece - 下一个方块预览 Canvas
 * @param {HTMLCanvasElement} canvas.holdPiece - 缓存方块 Canvas
 * @param {number} canvas.rows - 棋盘行数
 * @param {number} canvas.cols - 棋盘列数
 * @returns {void}
 */
const resize = (canvas) => {
