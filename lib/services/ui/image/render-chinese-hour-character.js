import ChineseHourCharacters from '@/lib/services/ui/constants/chinese-hour-characters.js';
 ...
 * ============================================================
 *
 * 使用策略模式，根据不同时间段返回对应的布局参数。 每天分为 7 个时段，每个时段有独特的字符位置和大小。
 *
 * | 时段            | 小时范围 | 说明 |
 * | :-------------- | :------- | :--- |
 * | night_0_3       | 0-3      | 深夜 |
 ...
 * ============================================================
 *
 * 根据当前时间获取对应的时辰字符， 选择对应时段的布局策略并渲染到画布上。
 *
 * ## 视觉效果
 *
