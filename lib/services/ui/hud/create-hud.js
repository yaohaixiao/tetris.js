...
import createHUDAnimator from '@/lib/services/ui/hud/create-hud-animator.js';
...
const createHud = () => {
  ...
  const updateScore = (next) => {
    ...
    scoreAnimation = createHUDAnimator(
      prev.score,
      target.score,
      300,
      // 每帧更新 UI
