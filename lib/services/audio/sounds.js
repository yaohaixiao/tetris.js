  ...
  clear: (lines = 1, isPerfectClear = false) => {
    ...
    for (const [i, freq] of chord.entries()) {
      setTimeout(() => {
        ...
        playTone(freq, speeds[i] * cfg.speed, options);
      }, timeouts[i]);
    }
  },
  // 升级庆祝音效
