...
class GamepadController {
  ...
  _onConnect = (e) => {
    ...
    EventBus.emit('game:update:gamepad:connected', { connected: true });
  ...
  _onDisconnect = (e) => {
    ...
    EventBus.emit('game:update:gamepad:connected', { connected: false });
  ...
  _getMoveUpAction(mode, level) {
    ...
    if (mode === 'main-menu') {
      ...
      EventBus.emit('game:update:level', { level });
