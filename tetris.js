var tetris = (() => {
  ...
  var drawTetrisText = () => {
    ...
    const { gameBoard: gameBoard2, gameBoardContext: gameBoardContext2, fontSize: fontSize2 } = canvas_default;
    const { width, height } = gameBoard2;
  ...
  var drawLevelSelect = (level) => {
    const { RGBA_BLACK: RGBA_BLACK2, GREEN: GREEN3, WHITE: WHITE2 } = colors_default;
    const { FONT_FAMILY: FONT_FAMILY2 } = game_default;
    const { gameBoard: gameBoard2, gameBoardContext: gameBoardContext2, fontSize: fontSize2 } = canvas_default;
    const { width, height } = gameBoard2;
    clear_board_default();
  ...
  var resize = () => {
    ...
    const { isSelectLevel, isGameOver, board, curr, cx, cy, level, next } = game_state_default;
  ...
  var updateUI = (score, lines, level, highScore) => {
    ...
    document.querySelector("#highScore").textContent = pad_default(highScore, 5);
  };
  ...
  var drawCountdownEffect = () => {
    const { YELLOW: YELLOW3, BLACK: BLACK2, RGBA_BLACK: RGBA_BLACK2, GREEN: GREEN3 } = colors_default;
    const { FONT_FAMILY: FONT_FAMILY2 } = game_default;
    const { gameBoard: gameBoard2, gameBoardContext: gameBoardContext2, fontSize: fontSize2 } = canvas_default;
    const { width, height } = gameBoard2;
  ...
  // lib/ui/draw-over.js
  var drawOver = () => {
    const { RGBA_BLACK: RGBA_BLACK2, RED: RED3, YELLOW: YELLOW3 } = colors_default;
    const { FONT_FAMILY: FONT_FAMILY2 } = game_default;
    const { gameBoard: gameBoard2, gameBoardContext: gameBoardContext2, fontSize: fontSize2 } = canvas_default;
    const { width, height } = gameBoard2;
    gameBoardContext2.fillStyle = RGBA_BLACK2;
  ...
  var spawn = () => {
    ...
    game_state_default.curr = game_state_default.next || random_tetromino_default();
  ...
  function drawLevelUpEffect() {
    const { RGBA_BLACK: RGBA_BLACK2, BLACK: BLACK2, GREEN: GREEN3, YELLOW: YELLOW3 } = colors_default;
    const { FONT_FAMILY: FONT_FAMILY2 } = game_default;
    const { gameBoard: gameBoard2, gameBoardContext: gameBoardContext2, fontSize: fontSize2 } = canvas_default;
    const { width, height } = gameBoard2;
    const effect = effects_default.levelUp;
    ...
    gameBoardContext2.fillStyle = GREEN3;
    gameBoardContext2.fillText(`${game_state_default.level}`, width / 2, height / 1.85);
    gameBoardContext2.restore();
    gameBoardContext2.save();
    gameBoardContext2.textAlign = "center";
  ...
  var triggerClearEffect = () => {
    ...
    draw_curr_default(game_state_default.curr, game_state_default.cx, game_state_default.cy);
    ...
    if (update_clear_effect_default()) {
      ...
      game_state_default.score += CLEAR_SCORES2[clear2] * game_state_default.level;
  ...
  var updateMainLoop = (timestamp) => {
    ...
    if (!game_state_default.timestamp || timestamp - game_state_default.timestamp > dropInterval) {
      loop_default();
  ...
  var execute_return_to_level_selection_command_default = executeReturnToLevelSelectionCommand;
  ...
  var drawClock = () => {
    ...
    const { TEAL: TEAL3, RGBA_TEAL: RGBA_TEAL2, ORANGE: ORANGE3 } = colors_default;
    const { gameBoard: gameBoard2, gameBoardContext: gameBoardContext2 } = canvas_default;
    const { width, height } = gameBoard2;
  ...
  var drawPause = () => {
    const { RGBA_BLACK: RGBA_BLACK2, YELLOW: YELLOW3, WHITE: WHITE2 } = colors_default;
    const { FONT_FAMILY: FONT_FAMILY2 } = game_default;
    const { gameBoard: gameBoard2, gameBoardContext: gameBoardContext2, fontSize: fontSize2 } = canvas_default;
    const { width, height } = gameBoard2;
    clear_board_default();
  ...
  var execute_direction_control_commands_default = executeDirectionControlCommands;
