var tetris = (() => {
  ...
  var AnimationSystem = class extends core_default {
    ...
    hasBlocking(names = []) {
      ...
      for (const animation of this.#queue) {
        if (animation._finished) continue;
  ...
  var CountdownAnimation = class extends core_default {
    ...
    render() {
      const events = UIEvents(this.Game.id);
  ...
  var LevelUpAnimation = class extends core_default {
    ...
    dispose() {
      const { Scheduler: Scheduler2 } = this;
      if (this._spawnId != null) Scheduler2.cancel(this._spawnId);
      if (this._updateId != null) Scheduler2.cancel(this._updateId);
      if (this._endId != null) Scheduler2.cancel(this._endId);
      const events = AudioEvents();
