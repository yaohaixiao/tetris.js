var tetris = (() => {
  ...
  var Lt = { COLS: 10, ROWS: 20 },
    L = Lt;
  var de = document.querySelector('#game-board'),
    vt = de.getContext('2d'),
    ue = document.querySelector('#next-piece'),
    Tt = ue.getContext('2d'),
    At = 0,
    Mt = 0,
    Ot = {
  ...
  var Yt = () => {
    ...
    X = Yt;
  var qt = (e) => {
      let { RGBA_BLACK: t, GREEN: n, WHITE: i } = u,
        { FONT_FAMILY: m } = x,
  ...
  var Qt = (e, t, n) => {
    ...
    ge = Qt;
  var jt = () => {
      (he(o.board), o.curr && ge(o.curr, o.cx, o.cy));
    },
    A = jt;
  var Jt = () => {
  ...
  var eo = () => {
      let e = S(),
        { level: t, next: n } = o;
      e === 'game-over' || e === 'main-menu' ? B(t) : (A(), H(n));
    },
    V = eo;
  var to = () => {
      (K(), V());
  ...
  var io = {
    ...
    d = io;
  var ao = (e) => {
      let { YELLOW: t, BLACK: n, RGBA_BLACK: i, GREEN: m } = u,
        { FONT_FAMILY: s } = x,
      ...
      (b(),
        ...
        (a.fillStyle = m),
        (a.strokeStyle = n),
        a.strokeText('GET READY!', c / 2, h / 1.46),
        a.fillText('GET READY!', c / 2, h / 1.46),
        a.restore(),
        a.restore());
    },
    ie = ao;
  ...
  var go = () => {
      ...
      (v('game-over'), J(), M(), d.gameOver(), Oe(), Z());
    },
    ee = go;
  var {
      BLUE: So,
      ...
      for (let s = 0; s < m.length; s++)
        for (let l = 0; l < m[s].length; l++)
          if (m[s][l]) {
            let a = o.cx + l + e,
              r = o.cy + s + t;
            if (a < 0 || a >= i || r >= n || (r >= 0 && o.board[r][a]))
              return !0;
          }
      return !1;
    },
  ...
  var Go = () => {
    ...
    k = Go;
  var Co = () => Math.max(100, 1e3 - (o.level - 1) * 80),
    ye = Co;
  var Ro = (e, t) => (W(e, t) ? !1 : ((o.cx += e), (o.cy += t), d.move(), !0)),
    P = Ro;
  var Bo = () => {
      let { curr: e } = o,
        t = e.shape;
  ...
  var wo = (e) => {
    ...
    Ge = wo;
  var bo = (e, t) => e.toString().padStart(t, '0'),
    C = bo;
  var Io = {
  ...
  var _o = (e, t, n, i, m = !1) => {
    ...
    N = _o;
  var { TEAL: No, YELLOW: Fo, PURPLE: Ho, ORANGE: Vo, GREEN: Do, RED: Wo } = u,
    $o = [No, Fo, Ho, Vo, Do, Wo],
    me = $o;
  var zo = (e) => {
    ...
    Be = zo;
  function Uo(e) {
    let { RGBA_BLACK: t, BLACK: n, GREEN: i, YELLOW: m } = u,
      { FONT_FAMILY: s } = x,
      { gameBoard: l, gameBoardContext: a, fontSize: r } = f,
      { width: c, height: h } = l;
    return e.show
      ? (a.save(),
        ...
        (a.font = `${r * 1.2}px ${s}`),
        (a.fillStyle = i),
        a.fillText('LEVEL UP', c / 2, h / 2.5),
        a.restore(),
        a.save(),
        (a.textAlign = 'center'),
        (a.font = `${r * 2.5}px ${s}`),
        (a.fillStyle = i),
        a.fillText(`${o.level}`, c / 2, h / 1.85),
        a.restore(),
        a.save(),
        (a.textAlign = 'center'),
        (a.font = `${r * 1.3}px ${s}`),
        ...
        (a.strokeStyle = n),
        (a.lineWidth = 3),
        a.strokeText('CONGRATS!', c / 2, h / 1.6),
        a.fillText('CONGRATS!', c / 2, h / 1.6),
        a.restore(),
        Be(e),
        a.restore(),
        !0)
  ...
  var le = class {
      ...
      createFireworks() {
        ...
        for (let m = 0; m < 40; m++) {
          ...
          i.push({
            ...
            color: me[Math.floor(Math.random() * me.length)],
            alpha: 1,
          });
        }
        return i;
      ...
      render() {
        we({ show: !0, fireworks: this.fireworks });
      }
    },
    be = le;
  var Yo = () => {
  ...
  var Xo = () => {
      ...
      return e === 'game-over' ||
        e === 'main-menu' ||
        Q() ||
        (!P(0, 1) && (te(), d.fall(), oe(), k(), e === 'game-over'))
        ? !1
        : (A(), !0);
    },
    _e = Xo;
  var Ne = (e) => {
      ...
      ((g.timestamp = e), Le(t));
      let n = ye();
      ((!g.accumulator || e - g.accumulator > n) && (_e(), (g.accumulator = e)),
        V(),
        ve(),
        (g.rafId = requestAnimationFrame(Ne)));
    },
    $ = Ne;
  var Qo = () => {
      (Z(), (g.rafId = requestAnimationFrame($)));
    },
    z = Qo;
  var jo = () => {
  ...
  var ur = (e, t = 'yyyy-MM-dd HH:mm:ss') => {
      let n = e.getFullYear(),
        ...
        E = t;
      for (let T of Object.keys(h)) E = E.replace(T, h[T]);
      return E;
    },
    Qe = ur;
  var hr = () => {
  ...
  var Er = () => {
    ...
    rt = Er;
  var Lr = { RESTART: Xe, QUIT: ee, TOGGLE_PAUSE: ot, TOGGLE_MUSIC: rt },
    vr = (e) => {
      let t = Lr[e];
