var tetris = (() => {
  ...
  var Eo = (t, e, r, o = {}) => {
      ...
      let { Context: s } = t,
        ...
        h = s.createGain();
      ((f.type = d), f.frequency.setValueAtTime(e, c));
      let g = (r / 1e3) * n,
        {
          attackTime: E = 0.003,
          releaseTime: R = 0.02,
      ...
      (h.gain.setValueAtTime(1e-4, L),
        h.gain.linearRampToValueAtTime(i, D),
        h.gain.linearRampToValueAtTime(i * C, oe),
        h.gain.exponentialRampToValueAtTime(1e-4, ae),
        f.connect(h),
        h.connect(s.destination),
        f.start(L),
        f.stop(ae + 0.05),
        f.addEventListener('ended', () => {
          (f.disconnect(), h.disconnect());
        }));
    },
    T = Eo;
  var vo = (t, e = !1) => (e ? 'perfect' : t === 4 ? 'tetris' : 'combo'),
    we = class extends q {
      constructor(e) {
        super(e);
      }
      ...
      CLEAR = (e = 1, r = 1, o = !1) => {
        let s = Math.min(Math.floor((r - 1) / 16), 15),
          ...
          E = i[m].filter((D) => D > 0).map((D) => D + h.shift * 12),
          R = [],
          { Context: C, Scheduler: L } = this;
        for (let [D, oe] of E.entries())
          R.push({
            fn: () => {
              let ae = C.currentTime;
              T(this, oe, n[D] * h.speed * d.spdMul, {
                volume: a[D] * h.volume * d.volMul,
                wave: d.wave,
                startTime: ae + c[D] / 1e3,
              });
            },
          });
        L.sequence(R);
  ...
  var _o = [
    ...
    go = [0, 100, 300, 500, 800, 1200],
    So = '"Press Start 2P", monospace, sans-serif',
    To = 256,
    Lo = {
      CLEAR_LINE_SCORES: go,
      FONT_FAMILY: So,
      AI_ALLOWED_ACTIONS: _o,
      MAX_LEVEL: To,
    },
    x = Lo;
  var Ao = {
  ...
  var Ho = {
    ...
    wt = Ho;
  var Uo = [vt, _t, gt, St, Tt, Lt, At, Rt, Ct, xt, Ot, yt, Mt, Gt, Dt, wt],
    Pe = Uo;
  var ko = 0.12,
    zo = 25,
    Vo = (t, e, r = {}) => {
      ...
      let f = 0,
        ...
        g = () => {
          let R = c.currentTime + ko;
          for (; h < R; ) {
            let C = e[f];
            m(C, h);
            let L = C.dur * o;
            ((h += L / 1e3), (f = (f + 1) % e.length));
          }
        };
      t.bgmSchedulerId = a.interval(g, zo);
    },
    Pt = Vo;
  var Fo = (t, e) => {
      let { length: r } = Pe,
    ...
    Wo = (t, e = 1) => {
      ...
      Pt(t, o, { duration: s, volume: i, wave: d, gate: n, articulation: a });
    },
    fe = Wo;
  var $o = (t) => {
    ...
    le = $o;
  var Yo = (t, e) => {
      t.bgmSchedulerId === 0 ? fe(t, e) : le(t);
    },
    It = Yo;
  var se = (t) => ({ CLEAR: `animations:${t}:clear` }),
    v = () => ({
    ...
    B = (t) => ({ START: `ai:${t}:start`, STOP: `ai:${t}:stop` }),
    Y = (t) => ({
  ...
  var Ie = class extends q {
      ...
      initialize(e) {
        ...
        ((this.Context = r),
          (this.Sounds = new Et({ ...e, Context: r })),
  ...
  var Ko = {
    ...
    bt = Ko;
  var Xo = '#00c8ff',
    Jo = 'rgba(0, 200, 255, 0.3)',
    Qo = '#f1fa04',
    jo = 'rgba(255, 255, 0, 0.3)',
    Zo = '#d31ac1',
    e1 = 'rgba(211, 26, 193, 0.3)',
    t1 = '#5050ff',
    r1 = 'rgba(80, 80, 255, 0.3)',
    o1 = '#ffa500',
    s1 = 'rgba(255, 127, 0, 0.3)',
    i1 = '#0afa04',
    n1 = '#5c9d31',
    d1 = 'rgba(0, 255, 0, 0.3)',
    a1 = '#ff3b30',
    c1 = 'rgba(255, 59, 48, 0.3)',
    f1 = '#e64a19',
    l1 = 'rgba(230, 74, 25, 0.3)',
    u1 = '#444',
    h1 = 'rgba(0, 0, 0, 0.3)',
    m1 = '#fff',
    p1 = 'rgba(255, 255, 255, 0.3)',
    q1 = '#ff4fa3',
    E1 = 'rgba(255, 79, 163, 0.3)',
    v1 = '#7b34eb',
    _1 = 'rgba(123, 52, 235, 0.3)',
    g1 = '#0cc0df',
    S1 = 'rgba(12, 192, 223, 0.3)',
    T1 = '#ff6b6b',
    L1 = '#ffa502',
    A1 = '#ffd700',
    R1 = '#ff7f50',
  ...
  var {
    ...
    ws = (t, e, r) => {
      ...
      for (let i = 0; i < t; i += 1) {
        ...
        let n = e - 3,
          a = 1 + Math.floor(Math.random() * n),
          c = new Set();
        for (; c.size < a; ) c.add(Math.floor(Math.random() * e));
        for (let f of c) d[f] = '';
        s.push(d);
      }
      return s;
  ...
  var Be = class {
      ...
      setState(e) {
        this.state = { ...this.state, ...(U(e) ? e(this.state) : e) };
      }
      resetState() {
      ...
      getHub() {
        let { source: e, lines: r, level: o } = this.state;
        return { source: e, lines: r, level: o };
      }
      setHud(e) {
        let { score: r, lines: o, level: s } = e;
        ((this.state.score = r),
          (this.state.lines = o),
          (this.state.level = s));
      }
  ...
  var Ue = class {
      ...
      initialize(e) {
        ...
        ((this.style = n),
          ...
          (this.rows = o),
          (this.cols = r),
          (this.gameBoard = document.querySelector(`#${s}`)),
          (this.gameBoardContext = this.gameBoard.getContext('2d')),
          (this.nextPiece = document.querySelector(`#${i}`)),
          (this.nextPieceContext = this.nextPiece.getContext('2d')),
          (this.holdPiece = document.querySelector(`#${d}`)),
  ...
  var Is = (t, e) => {
    ...
    k = Is;
  var Ns = (t) => {
      let { controller: e, score: r, lines: o, level: s, highScore: i } = t;
      return {
        ...
        highScore: document.querySelector(`#${i}`),
      };
    },
    Wt = Ns;
  var V = (t, e, r = 0) => (t.textContent = r ? k(e, r) : String(e)),
    $t = (t, e, r) => {
    ...
    ke = class {
      ...
      update(e) {
        ...
        ((o.target = Number(e.score) || 0),
          ...
          e.lines !== i.lines && (V(r.lines, e.lines, 2), (i.lines = e.lines)),
          e.level !== i.level && (V(r.level, e.level, 2), (i.level = e.level)));
      }
      updateController(e) {
      ...
      tick() {
        ...
        ($t(r, e.score, 5), $t(o, e.highScore, 5));
      }
      reset() {
        let {
          elements: e,
  ...
  var bs = (t, e) => {
      let {
        ...
        { FONT_FAMILY: g } = x,
        { gameBoardContext: E, fontSize: R } = t;
      (E.save(),
        m < 1 && (E.globalAlpha = m),
        ...
        (E.font = `${R * n}px ${g}`),
        f &&
          ((E.strokeStyle = d || i), (E.lineWidth = h), E.strokeText(r, o, s)),
        (E.fillStyle = i),
        E.fillText(r, o, s),
        m < 1 && (E.globalAlpha = 1),
        E.restore());
  ...
  var { RGBA_WHITE: he } = u,
    ...
    z = Ws;
  var ze = new Map(),
    $s = (t) => `data:image/svg+xml;charset=utf-8,${encodeURIComponent(t)}`,
    w = (t) => {
      let e = ze.get(t);
      if (e) return e;
      let r = new Image();
      return ((r.src = $s(t)), ze.set(t, r), r);
    },
    Ys = () => {
      ze.clear();
    },
  ...
  var Xs = (t, e) => {
      ...
      switch (e) {
        case 'main-menu':
        case 'countdown': {
          ((n = w(z.tetris)), (a = o), (c = o / 2 - a / 2), (f = s - a));
          break;
        }
        case 'playing': {
          (i >= 0 && i <= 8
  ...
  var {
    ...
    A2 = {
      Teal: { stroke: me, face: f2, secondHand: pe },
      Violet: { stroke: g2, face: S2, secondHand: me },
      Yellow: { stroke: Fe, face: v2, secondHand: pe },
      Pink: { stroke: l2, face: u2, secondHand: Fe },
      Purple: { stroke: a2, face: c2, secondHand: me },
      Green: { stroke: pe, face: p2, secondHand: me },
      Blue: { stroke: q2, face: E2, secondHand: Fe },
      Coral: { stroke: i2, face: n2, secondHand: Ve },
      Orange: { stroke: h2, face: m2, secondHand: We },
      Cyan: { stroke: T2, face: L2, secondHand: pe },
      White: { stroke: Ve, face: d2, secondHand: We },
      Red: { stroke: We, face: _2, secondHand: Ve },
    },
    qe = A2;
  var R2 = (t, e = 'yyyy-MM-dd HH:mm:ss') => {
      let r = t.getFullYear(),
        o = t.getMonth() + 1,
        s = t.getDate(),
        i = t.getHours(),
        ...
        m = e;
      for (let g of Object.keys(h)) m = m.replaceAll(new RegExp(g, 'g'), h[g]);
      return m;
    },
    nr = R2;
  var C2 = (t) =>
  ...
  var U2 = (t, e, r, o) => {
      let { gameBoardContext: s, blockSize: i } = t,
        ...
        f = Q(o, 0.15),
        h = K(o, 0.25),
        m = s.createLinearGradient(d, n, d, n + c);
      (m.addColorStop(0, f),
        ...
        s.beginPath(),
        s.moveTo(d, n),
        s.lineTo(d + a * 0.3, n + c * 0.5),
        s.lineTo(d, n + c),
        s.fill(),
        (s.fillStyle = 'rgba(0, 0, 0, 0.06)'),
        s.beginPath(),
        s.moveTo(d + a, n),
        s.lineTo(d + a * 0.7, n + c * 0.5),
        s.lineTo(d + a, n + c),
        s.fill());
    },
    vr = U2;
  var W = (t) => {
      let { ctx: e, px: r, py: o, w: s, h: i, u: d, steps: n, color: a } = t;
      ((e.fillStyle = a),
    ...
    _r = (t) => {
      ...
      (W({ ctx: e, px: r, py: o, w: s, h: i, u: d, steps: 0, color: a }),
        W({ ctx: e, px: r, py: o, w: s, h: i, u: d, steps: 1, color: n }),
        W({ ctx: e, px: r, py: o, w: s, h: i, u: d, steps: 2, color: a }));
    },
    k2 = (t, e, r, o, s = 'square') => {
      ...
      switch (s) {
        case 'jay': {
          (_r({ ctx: i, px: a, py: c, w: f, h, u: n, color: o, darkColor: m }),
            W({ ctx: i, px: a, py: c, w: f, h, u: n, steps: 3, color: g }));
          break;
        }
        case 'ell': {
          (W({ ctx: i, px: a, py: c, w: f, h, u: n, steps: 0, color: m }),
            W({ ctx: i, px: a, py: c, w: f, h, u: n, steps: 1, color: o }));
          break;
        }
        case 'tee': {
          (W({ ctx: i, px: a, py: c, w: f, h, u: n, steps: 0, color: m }),
            W({ ctx: i, px: a, py: c, w: f, h, u: n, steps: 1, color: o }),
            (i.fillStyle = g),
            i.fillRect(a + n * 2, c + n * 2, n, h - n * 4),
            i.fillRect(a + n * 2, c + n * 2, f - n * 4, n),
            (i.fillStyle = m),
            i.fillRect(a + n * 2, c + n * 5, f - n * 4, n),
            i.fillRect(a + n * 5, c + n * 3, n, h - n * 6));
          break;
        }
        default:
          _r({ ctx: i, px: a, py: c, w: f, h, u: n, color: o, darkColor: m });
  ...
  var z2 = (t, e, r, o) => {
      let { gameBoardContext: s, blockSize: i } = t,
        ...
        g = K(o, 0.22);
      ((s.fillStyle = g),
        s.fillRect(d, n + c / 2, a, c / 2),
        (s.fillStyle = h),
        s.fillRect(d, n, a, c / 2),
        (s.fillStyle = f),
        s.beginPath(),
        s.moveTo(d, n),
        s.lineTo(d + a / 2, n + c / 2),
        s.lineTo(d, n + c),
        s.fill(),
        (s.fillStyle = m),
        s.beginPath(),
  ...
  var $2 = {
    ...
    K2 = (t) => {
      let { gameBoard: e } = t,
        ...
        n = Y2(s),
        a = $2[n],
        { size: c, x: f, y: h } = a(r, o);
      F(t, { img: d, x: f, y: h, size: c });
    },
    Ar = K2;
  var X2 = (t, e) => {
      let { rows: r, cols: o } = t;
      (O(t), Ar(t), G(t, 'playing'));
      for (let s = 0; s < r; s++)
        for (let i = 0; i < o; i++) e[s][i] && H(t, i, s, e[s][i]);
    },
    Rr = X2;
  var J2 = (t, e, r, o) => {
      let { shape: s, color: i } = e,
        { length: d } = s;
      for (let n = 0; n < d; n++)
        for (let a = 0; a < s[n].length; a++) s[n][a] && H(t, r + a, o + n, i);
      return !0;
    },
    Cr = J2;
  var Q2 = (t, e) => {
      let { board: r, curr: o, cx: s, cy: i } = e;
      (r && Rr(t, r), o && Cr(t, o, s, i));
    },
    j = Q2;
  var j2 = (t, e) => {
      (O(t), j(t, e), M(t), G(t, 'paused'), y(t), dr(t), qr(t), ir(t));
    },
    xr = j2;
  var Z2 = (t, e) => {
      xr(t, e);
  ...
  var ti = (t) => {
    ...
    _e = ti;
  var ri = (t, e) => {
      (O(t), j(t, e), M(t), G(t, 'game-over'), y(t), ve(t), _e(t), J(t));
    },
    yr = ri;
  var oi = (t, e) => {
      yr(t, e);
  ...
  var ii = (t, e) => {
      ...
      let { shape: c } = r,
        f = Math.ceil(n / 6),
        h = Math.floor((n - c[0].length * f) / 2),
        m = Math.floor((a - c.length * f) / 2);
      (ge(t), d.save(), d.translate(h, m));
      for (let g = 0; g < c.length; g++)
        for (let E = 0; E < c[g].length; E++)
          c[g][E] &&
            H(
              {
                gameBoardContext: d,
  ...
  var ci = (t, e) => {
    ...
    Gr = ci;
  var fi = (t, e) => {
      (O(t), Ae(t, e), M(t), G(t, 'game-over'), y(t), ve(t), _e(t), J(t));
    },
    Dr = fi;
  var li = (t, e) => {
      Dr(t, e);
  ...
  var pi = (t) => {
      ...
      if (d >= 480) {
        let m = n * 0.9;
        ((a = Math.floor(m / s)), (c = f = Math.min(d * 0.1, n * 0.18)));
      } else {
        let m = d * 0.64;
        ((a = Math.min(Math.floor(m / i), Math.floor((n * 0.68) / s))),
          (c = f = a * 5));
      }
      let h = Math.floor(a * s * 0.032);
      ((t.blockSize = a),
        (e.width = a * i),
        (e.height = a * s),
        (t.fontSize = h),
  ...
  var qi = (t, e) => {
      ...
      for (let s of e.lines) {
        ...
        for (let i = 0; i < o; i++) H(t, i, s.y, s.color);
        r.restore();
      }
    },
    Br = qi;
  var Ei = (t, e) => {
      let { WHITE: r } = u,
        { gameBoard: o, blockSize: s } = t,
        { width: i } = o,
        { score: d, y: n, alpha: a, offsetY: c } = e;
      if (a <= 0) return;
      let f = i / 2,
        h = n * s + s / 2 - c;
      S(t, {
    ...
    br = Ei;
  var vi = (t, e, r = 1) => {
      let { YELLOW: o, BLACK: s } = u,
        { FONT_FAMILY: i } = x,
        { gameBoard: d, gameBoardContext: n, fontSize: a } = t,
        { width: c, height: f } = d;
      (n.save(),
        (n.textAlign = 'center'),
        ...
        (n.lineWidth = 6));
      let h = String(e);
      (n.strokeText(h, 0, 0), n.fillText(h, 0, 0), n.restore());
    },
    Hr = vi;
  var _i = (t) => {
      let { GREEN: e, BLACK: r } = u,
        { gameBoard: o } = t,
        { width: s, height: i } = o;
      S(t, {
        text: 'GET READY!',
  ...
  var gi = (t) => {
      let { gameBoard: e } = t,
        ...
        d = r / 2 - i / 2,
        n = o / 2 - i * 1.2;
      F(t, { img: s, x: d, y: n, size: i });
    },
    kr = gi;
  var Si = (t, e) => {
      let { number: r, scale: o } = e;
      (O(t), M(t), y(t), G(t, 'countdown'), kr(t), Ur(t), Hr(t, r, o));
    },
    zr = Si;
  var Ti = (t, e) => {
      let { gameBoardContext: r } = t;
  ...
  function Ri(t, e, r) {
    let { gameBoard: o } = t,
      { height: s } = o;
    (M(t), y(t), Fr(t), ue(t, e, s / 1.85), Wr(t), Vr(t, r));
  }
  var $r = Ri;
  var Ci = (t, e) => {
      if (!e) return;
  ...
  var $e = class extends q {
      ...
      initialize(e) {
        let { Elements: r, Block: o } = e,
          { Hud: s, Canvas: i } = r;
        ((this.Hud = new Yt(s)), (this.Canvas = new Ft({ ...i, ...o })));
      }
      updateMode(e) {
      ...
      updateHud() {
        ...
        ((o === 'main-menu' || a) && this.Hud.reset(),
          this.Hud.update({ score: s, lines: i, level: d, highScore: n }));
      }
      tickHud() {
        this.Hud.tick();
      }
      lazyRender() {
        let { Store: e } = this;
        Ir(this.Canvas, e.getState());
      }
      render() {
        let { Store: e } = this;
        ie(this.Canvas, e.getState());
      }
      resize() {
        Nr(this.Canvas);
      }
  ...
  var Ke = class extends q {
      ...
      initialize(e) {
        let { Game: r } = this;
        ((this.Renderer = new Kr(e)),
          (this.Router = new Xr({ UI: this, Game: r })));
      }
      updateMode(e) {
    ...
    Qe = class extends q {
      ...
      _onConnect = (e) => {
        ...
        ((this.activeGamepadIndex = r.index),
          (this.curBtnMap = this._isBetop(r.id) ? t0 : Je));
        let { Game: o } = this,
          s = l(o.id);
      ...
      _handleStandardButtons(e, r, o, s) {
        ...
        for (let [c, f] of Object.entries(b)) {
          let h =
              !f ||
              ((r === 'replay' || r === 'game-over') && c !== 'START') ||
              (a === 'ai' &&
                r === 'playing' &&
                !x.AI_ALLOWED_ACTIONS.includes(f)),
            m = c.startsWith('DPAD_');
          if (!this._isPressed(c) || (i && m)) continue;
          if (h) return this;
          let g = this._resolveAction(f, c, m, r, o, s);
          g &&
            this.emit('dispatch:input', {
              device: 'gamepad',
              action: g,
      ...
      _collectCommands(e) {
        ...
        let n = this._getAxis(this.AXIS_MAP.LEFT_STICK_X),
          a = this._getAxis(this.AXIS_MAP.LEFT_STICK_Y);
        if ((this._handleStickMove(n, a), this._isBetop(d.id))) {
          let c = d.axes[9] ?? 0;
  ...
  var Pi = (t, e, r) => {
      let o = 0;
      for (; !i0(t, e, r, o + 1); ) o += 1;
      return { board: Re(t, e, r, o), y: o };
    },
    d0 = Pi;
  var Ii = (t, e) => {
      let r = t[0].length,
    ...
    bi = ({ rotationCount: t, targetX: e, originalX: r }) => {
      let o = [];
      return (Ni(o, t), Bi(o, e - r), o.push('DROP'), o);
    },
    Hi = ({
      board: t,
      currentShape: e,
      ...
      let i = d0(t, e, r),
        d = bi({ rotationCount: s, targetX: r, originalX: o.position.x });
      return { board: i.board, actions: d };
    },
    Ui = (t) => {
      let { board: e, piece: r } = t,
        o = [],
        s = r.shape;
      for (let i = 0; i < 4; i++) {
        let d = Ii(e, s);
  ...
  var Vi = (t, e) => {
      ...
      for (let a = 0; a < t[0].length; a++) r.push(c0(t, a));
      let s = r.reduce((a, c) => a + c, 0),
        i = 0;
      for (let a = 0; a < r.length - 1; a++) i += Math.abs(r[a] - r[a + 1]);
      let d = f0(t),
        n = 0;
      for (let a of t) a.every((c) => c !== 0) && (n += 1);
      return (
        s * o.height +
        d * o.holes +
        i * o.bumpiness +
        Math.pow(n, 2) * o.completeLines
      );
    },
    ne = Vi;
  var Fi = [
  ...
  var {
    ...
    r5 = [
      [Wi, $i, Yi, Ki, Xi, Ji, Qi, ji],
      [Zi, en, tn, rn, on, sn, nn, dn],
      [an, cn, fn, ln, un, hn, mn, pn],
      [qn, En, vn, _n, gn, Sn, Tn, Ln],
      [An, Rn, Cn, xn, On, yn, Mn, Gn],
      [Dn, wn, Pn, In, Nn, Bn, bn, Hn],
      [Un, kn, zn, Vn, Fn, Wn, $n, Yn],
      [Kn, Xn, Jn, Qn, jn, Zn, e5, t5],
    ],
    Ze = r5;
  var o5 = (t = 1) => {
      let e = Math.floor(Math.random() * je.length),
        r = je[e],
        o = Math.min(Math.floor((t - 1) / 32), Ze.length - 1),
        s = Ze[o];
      return {
        shape: r.shape.map((i) => [...i]),
        color: s[r.colorIndex],
        type: r.type,
  ...
  var s5 = (t) => {
    ...
    l0 = s5;
  var i5 = (t, e) => {
      let r = Re(t.board, t.piece.shape, t.piece.position.x, e.y),
        o = l0(r),
        s = t.next || ee(),
        i = {
          shape: s.shape,
          position: {
            x: Math.floor(10 / 2) - Math.floor(s.shape[0].length / 2),
            y: 0,
          },
        };
      return { ...t, board: o, piece: i, cur: s, next: ee() };
    },
    u0 = i5;
  var h0 = (t, e, r = 1, o = 5) => {
      let s = a0(t);
      ...
      if (r > 1 && s.length > o) {
        let n = s.map((a) => ({ move: a, score: ne(a.board, e) }));
        (n.sort((a, c) => c.score - a.score),
          (s.length = 0),
          s.push(...n.slice(0, o).map((a) => a.move)));
      }
      let i = null,
        d = -1 / 0;
      for (let n of s) {
        let a;
        if (r <= 1) a = ne(n.board, e);
        else {
          let c = u0(t, n),
            f = h0(c, e, r - 1, o);
          a = f ? ne(f.board, e) : ne(n.board, e);
        }
        a > d && ((d = a), (i = n));
      }
      return i;
  ...
  var et = class extends q {
      ...
      getDifficultyConfig() {
        ...
        return (
          { easy: Z.EASY, normal: Z.NORMAL, hard: Z.HARD, expert: Z.EXPERT }[
            r
          ] || Z.NORMAL
        );
      }
  ...
  var ot = class extends q {
      ...
      initialize() {
        ((this.recording = !1),
          ...
          (this.timestamp = 0));
        let { Game: e } = this;
        this.Router = new v0({ Replay: this, Game: e });
      }
      getNextPiece() {
      ...
      update({ speed: e, timestamp: r }) {
        ...
        if (a) {
          let c = e ?? 1e3,
            f = a.ms - this.playElapsed;
          if (f > c * 2) {
            let h = Math.min(f - c, 1e3);
            ((this.playElapsed += h), (this.startTime = r - this.playElapsed));
          }
        }
        for (
          ;
  ...
  var it = class extends q {
    ...
    S0 = it;
  var a5 = (t) => Array.from({ length: t }).fill(0),
    c5 = (t, e) => {
      let r = 1,
        o = 10,
        s = 0;
    ...
    f5 = (t) => {
      let { MAX_LEVEL: e, CLEAR_LINE_SCORES: r } = x,
        { Elements: o, Store: s } = t,
        i = s.getState(),
        { cols: d } = o.Canvas,
        n = [...(i.clearLines || [])].toSorted((L, D) => D - L),
        a = n.length,
        c = structuredClone(i.board);
      for (let L of n) c.splice(L, 1);
      for (let L = 0; L < a; L++) c.unshift(a5(d));
      let f = i.lines + a,
        h = i.baseLines + f,
        { level: m, levelUpSteps: g } = c5(h, e),
        E = m > i.level,
        C = (r[a] || 0) * m;
      return {
        stateHandler: (L) => ({
  ...
  var nt = class extends q {
      ...
      initialize(e) {
        ...
        this.lines = r.map((m) => ({
          y: m,
          alpha: 1,
          color: i.getState().next?.color || u.WHITE,
        }));
        let { clearScore: a } = de(s),
          c = () => {
        ...
        this._schedulerIds.push(...f);
        let h = o.delay(() => {
          this._finished = !0;
        }, 720);
        (this._schedulerIds.push(h),
      ...
      dispose() {
        ...
        e.sequence([
          {
            fn: () => {
              this.emit(a.STOP_CLEAR_LINES, { isLevelUp: d, level: i });
            },
          },
          {
            fn: () => {
  ...
  var dt = class extends q {
      ...
      initialize() {
        ...
        ((this.layer = 300),
          ...
          (this._finished = !1),
          (this.state = { score: o, y: s[s.length - 1], alpha: 1, offsetY: 0 }),
  ...
  var at = class extends q {
      ...
      createFireworks() {
        let { UI: e } = this,
          ...
          s = [u.TEAL, u.YELLOW, u.PURPLE, u.ORANGE, u.GREEN, u.RED, u.PINK],
          i = [];
        for (let d = 0; d < 40; d++) {
  ...
  var ct = class extends q {
      ...
      initialize() {
        ...
        for (let n = 0; n < o.length; n++)
          for (let a = 0; a < o[n].length; a++)
            o[n][a] && d.push({ x: s + a, y: i + n });
        ((this.state = { cells: d }),
          (this._endId = r.delay(() => {
            this._finished = !0;
          }, 150)));
  ...
  var l5 = (t) => {
      ...
      let o = r.getState(),
        { next: s, level: i } = o;
      return {
        curr: s ? { ...s, shape: s.shape.map((n) => [...n]) } : ee(i),
        next: ee(i),
      };
    },
    C0 = l5;
  var u5 = (t, e, r, o) => {
      let { Elements: s, Store: i } = t,
        ...
        a = i.getState(),
        { curr: c, cx: f, cy: h, board: m } = a;
      if (!c) return !1;
      let g = o || c.shape;
      for (let E = 0; E < g.length; E++)
        for (let R = 0; R < g[E].length; R++)
          if (g[E][R]) {
            let C = f + R + e,
              L = h + E + r,
              D = C < 0 || C >= n || L >= d,
  ...
  var m5 = (t) => {
      ...
      let a = _(e),
        c = A(e);
      (t.emit(a.RENDER_NEXT_PIECE, { state: n }), t.emit(c.ADD_PIECE, n.curr));
    },
    N = m5;
  var p5 = (t, e, r = 1) => {
      let { Store: o } = t;
  ...
  var S5 = (t, e = 'main-menu') => {
      ...
      (t.emit(s.STOP_BGM),
        ...
        te(t, e, f),
        t.emit(c.UPDATE_HUD, { state: o.getState() }),
        t.emit(c.UPDATE_MODE, { mode: e }),
        t.emit(c.CLEAR_NEXT_PIECE),
        t.emit(c.CLEAR_HOLD_PIECE),
        t.emit(i.STOP),
        o.setController('human'),
        t.emit(c.UPDATE_CONTROLLER, { controller: 'human' }),
        t.emit(a.RESET));
    },
    xe = S5;
  var T5 = (t) => {
  ...
  var L5 = (t, e, r) => {
      let { Store: o } = t,
        ...
        { cx: d, cy: n } = s;
      if (!$(t, e, r)) {
        ((d += e), (n += r), o.setState({ cx: d, cy: n }));
        let { curr: a } = o.getState();
        return (
          a._lockTimer && (a._lockTimer = 0),
          t.emit(i.PLAY_SOUND, { sound: 'MOVE' }),
          !0
        );
      }
      return !1;
  ...
  var A5 = (t) => (t === 'I' ? w0 : t === 'I5' ? P0 : t === 'O' ? null : I0),
    N0 = A5;
  var R5 = (t, e) => ((t ?? 0) + e + 4) % 4,
    B0 = R5;
  var C5 = (t) => {
      let e = t.length,
        r = t[0].length,
  ...
  var M5 = (t, e, r, o, s) => {
      ...
      for (let [n, a] of s) {
        let c = n,
          f = -a;
        if (!$(t, c, f, r)) return (Oe(t.Store, e, r, o, i + c, d + f), !0);
      }
      return !1;
    },
    k0 = M5;
  var G5 = (t, e, r, o) => ($(t, 0, 0, r) ? !1 : (Oe(t.Store, e, r, o), !0)),
    z0 = G5;
  var D5 = (t, e = 1) => {
      let { Store: r } = t,
        { curr: o } = r.getState();
      ...
      let s = U0(o.shape, e),
        ...
        n = v();
      if (d?.length) {
        let a = d[(o.rotation ?? 0) % 4];
        if (a?.length && k0(t, o, s, i, a)) {
          t.emit(n.PLAY_SOUND, { sound: 'ROTATE' });
          return;
        }
      }
      z0(t, o, s, i) && t.emit(n.PLAY_SOUND, { sound: 'ROTATE' });
    },
    V0 = D5;
  var w5 = (t) => {
      let { Store: e } = t,
      ...
      for (let d = 0; d < s.length; d++)
        for (let n = 0; n < s[d].length; n++)
          s[d][n] &&
            ((i[r.cy + d][r.cx + n] = o.color), e.setState({ board: i }));
    },
    ye = w5;
  var P5 = (t) => {
  ...
  var b5 = (t) => {
      ...
      let e = v(),
        r = l(t.id),
        { curr: o, cx: s, cy: i } = t.Store.getState();
      (ye(t),
        t.emit(r.START_LANDING_FLASH, {
          piece: { shape: o.shape, cx: s, cy: i },
        }),
        t.emit(e.PLAY_SOUND, { sound: 'FALL' }),
        Me(t),
        N(t),
        t.emit(e.PLAY_SOUND, { sound: 'DROP' }));
    },
    $0 = b5;
  var H5 = (t) => {
      ...
      if (d) {
        ...
        e.setState({
          curr: c,
          hold: f,
          cx: Math.floor(n / 2) - Math.floor(c.shape[0].length / 2),
          cy: 0,
        });
      } else (e.setState({ hold: { ...i, _held: !0 } }), N(t));
      let a = _(o);
      t.emit(a.RENDER_HOLD_PIECE);
    },
    Y0 = H5;
  var U5 = (t) => {
      let { MAX_LEVEL: e } = x,
    ...
    K0 = U5;
  var k5 = (t) => localStorage.getItem(t),
    X0 = k5;
  var z5 = (t, e) => {
  ...
  var ft = class extends q {
      ...
      initialize() {
        let { Elements: e, Block: r, Scheduler: o } = this,
          { Controls: s } = e,
          i = new kt({ ...e.Canvas, GameState: bt });
        ((this.id =
          crypto?.randomUUID?.() ||
          `${Date.now()}-${Math.random().toString(36).slice(2, 10)}`),
          (this.effect = null),
          (this.Store = i),
          (this.Animations = new Vt({ Game: this })),
          (this.CommandQueue = new zt({ Game: this })),
          (this.AI = new p0({
            Game: this,
            Store: i,
            Scheduler: o,
          ...
          (this.UI = new Jr({ Game: this, Store: i, Elements: e, Block: r })),
          (this.Keyboard = new Zr({ Game: this, Store: i })),
          (this.Gamepad = new r0({ Game: this, Store: i })),
          (this.Touch = new E0({ Game: this, Store: i, Controls: s })),
          (this.Replay = new _0({ Game: this, Store: i, Scheduler: o })),
          (this.Router = new Bt({
            Animations: this.Animations,
            AI: this.AI,
      ...
      loadHighScore() {
        let e = Number.parseInt(X0('tetris-high-score'), 10) || 0;
        this.Store.setHighScore(e);
      }
      saveHighScore(e) {
        let { Store: r } = this;
        e > r.getHighScore() &&
          (r.setHighScore(e), J0('tetris-high-score', e.toString()));
      }
      begin() {
        x0(this);
      }
      ...
      startCountdown() {
        let { Scheduler: e } = this;
        this.Animations.register(new g0({ Scheduler: e, Game: this }));
      }
      startPaused() {
        let { Scheduler: e } = this;
        ((this.effect = new S0({ Scheduler: e })),
      ...
      startClearLines(e) {
        ...
        this.Animations.register(
          new T0({ Game: this, Store: o, Scheduler: r, lines: e }),
        );
      }
      startClearScore(e) {
        let { Scheduler: r } = this;
        this.Animations.register(
          new L0({ Game: this, scoreData: e, Scheduler: r }),
        );
      }
      startLevelUp(e) {
        let { Scheduler: r, UI: o } = this;
        this.Animations.register(
          new A0({ Game: this, UI: o, level: e, Scheduler: r }),
        );
      }
      startLandingFlash(e) {
        let { Scheduler: r } = this;
        this.Animations.register(
          new R0({ Game: this, piece: e, Scheduler: r }),
        );
      }
      addEventListeners() {
  ...
  var V5 = (t, e) => {
      ...
      let { Game: d } = o,
        ...
        c = Y(a),
        f = A(a);
      (d.emit(c.ENQUEUE, { cmd: n }), d.emit(f.ADD_RECORD, { ms: i, cmd: n }));
    },
    Z0 = V5;
  var F5 = {
      LEVEL_ONE: (t) => {
  ...
  var p = {
      ...
      initialize: (t) => {
        p.Scheduler = new ht();
        let e = { ...t, Scheduler: p.Scheduler, isAIPlayer: !0 };
        ((p.Audio = new Nt(e)), (p.Game = new Q0(e)));
      },
      launch: () => {
        p.initialize(p.Configuration);
        let { Game: t } = p,
          { Store: e, UI: r } = t;
        (e.resetBoard(),
          t.loadHighScore(),
      ...
      tick: (t) => {
        p.lastTickTime || ((p.lastTickTime = t), (p.fixedAccumulator = t));
        let { Game: e, Scheduler: r } = p,
          {
            UI: o,
            Replay: s,
            Gamepad: i,
          ...
          c = n.hasBlocking(),
          f = t - p.fixedAccumulator;
        ((p.lastTickTime = t),
          r.tick(t),
          s.syncPlayElapsed({ timestamp: p.lastTickTime, isBlocked: c }),
          s.update({ speed: e.getSpeed(), timestamp: p.lastTickTime }),
          i.update(t),
          d.update(),
          a.flush(),
          (!p.fixedAccumulator || f > e.getSpeed()) &&
            !s.playing &&
            (e.tick(c), (p.fixedAccumulator = t)),
          n.flush(),
          o.tickHud(),
          o.render(),
          n.render(),
          (p.rafId = requestAnimationFrame(p.tick)));
      },
      subscribe: () => {
        let { Game: t, Audio: e } = p;
        (p._subscribe(), e.subscribe(), t.subscribe());
      },
      unsubscribe: () => {
        let { Game: t, Audio: e } = p;
        (p._unsubscribe(), e.unsubscribe(), t.unsubscribe());
      },
      _subscribe: () => {
        let { Game: t } = p;
        (t.on('dispatch:command', p._onDispatchCommand),
          t.on('dispatch:input', p._onDispatchInput));
      },
      _unsubscribe: () => {
        let { Game: t } = p;
        (t.off('dispatch:command', p._onDispatchCommand),
          t.off('dispatch:input', p._onDispatchInput));
      },
      _onDispatchCommand: (t) => {
        let { Game: e } = p,
          ...
          { payload: d } = t;
        ((d.isBlocked = i), no(t, { mode: s }));
      },
      _onDispatchInput: (t) => {
        let { Game: e } = p,
          { Animations: r, Replay: o } = e,
          s = r.hasBlocking(['clear-lines', 'countdown', 'level-up']),
          i = p.lastTickTime - o.startTime;
        Z0(t, { isBlocked: s, ms: i });
      },
      start: () => {
        p.rafId = requestAnimationFrame(p.tick);
      },
