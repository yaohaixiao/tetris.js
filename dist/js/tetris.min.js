var tetris = (() => {
  var H0 = {
      Block: { style: 'shaded', pattern: 'square' },
      Elements: {
        Canvas: {
          cols: 10,
          rows: 20,
  ...
  var W0 = (t, e, r, o = {}) => {
      ...
      let { Context: s } = t,
        ...
        f = s.createOscillator(),
        l = s.createGain();
      ((f.type = d), f.frequency.setValueAtTime(e, a));
      let E = (r / 1e3) * n,
        {
          attackTime: m = 0.003,
          releaseTime: T = 0.02,
        ...
        W = R + Math.max(E - T, m),
        X = R + E;
      (l.gain.setValueAtTime(1e-4, R),
        l.gain.linearRampToValueAtTime(i, D),
        l.gain.linearRampToValueAtTime(i * A, W),
        l.gain.exponentialRampToValueAtTime(1e-4, X),
        f.connect(l),
    ...
    L = W0;
  var Y0 = (t, e = !1) => (e ? 'perfect' : t === 4 ? 'tetris' : 'combo'),
    Ve = class extends _ {
      constructor(e) {
        super(e);
      }
      ...
      CLEAR = (e = 1, r = 1, o = !1) => {
        let s = Math.min(Math.floor((r - 1) / 16), 15),
          ...
          m = i[p].filter((D) => D > 0).map((D) => D + l.shift * 12),
          T = [],
          { Context: A, Scheduler: R } = this;
        for (let [D, W] of m.entries())
          T.push({
            fn: () => {
              let X = A.currentTime;
              L(this, W, n[D] * l.speed * d.spdMul, {
                volume: c[D] * l.volume * d.volMul,
                wave: d.wave,
                startTime: X + a[D] / 1e3,
              });
            },
  ...
  var K0 = [
    ...
    X0 = [0, 100, 300, 500, 800, 1200],
    J0 = '"Press Start 2P", monospace, sans-serif',
    Q0 = 256,
    j0 = {
      CLEAR_LINE_SCORES: X0,
      FONT_FAMILY: J0,
      AI_ALLOWED_ACTIONS: K0,
      MAX_LEVEL: Q0,
    },
    x = j0;
  var Z0 = {
  ...
  var m1 = {
    ...
    Yt = m1;
  var p1 = [Dt, wt, Pt, It, bt, Nt, Bt, Ht, kt, Ut, zt, Vt, Ft, $t, Wt, Yt],
    Fe = p1;
  var E1 = 0.12,
    q1 = 25,
    _1 = (t, e, r = {}) => {
      ...
      let f = 0,
        ...
        E = () => {
          let T = a.currentTime + E1;
          for (; l < T; ) {
            let A = e[f];
            p(A, l);
            let R = A.dur * o;
            ((l += R / 1e3), (f = (f + 1) % e.length));
          }
        };
      t.bgmSchedulerId = c.interval(E, q1);
    },
    Kt = _1;
  var v1 = (t, e) => {
      let { length: r } = Fe,
    ...
    g1 = (t, e = 1) => {
      ...
      Kt(t, o, { duration: s, volume: i, wave: d, gate: n, articulation: c });
    },
    he = g1;
  var S1 = (t) => {
    ...
    me = S1;
  var T1 = (t, e) => {
      t.bgmSchedulerId === 0 ? he(t, e) : me(t);
    },
    Xt = T1;
  ...
  var $e = class extends _ {
      ...
      initialize(e) {
        ...
        ((this.Context = r),
          (this.Sounds = new Gt({ ...e, Context: r })),
  ...
  var L1 = {
    ...
    jt = L1;
  var A1 = '#00c8ff',
    R1 = 'rgba(0, 200, 255, 0.3)',
    C1 = '#f1fa04',
    x1 = 'rgba(255, 255, 0, 0.3)',
    O1 = '#d31ac1',
    y1 = 'rgba(211, 26, 193, 0.3)',
    M1 = '#5050ff',
    G1 = 'rgba(80, 80, 255, 0.3)',
    D1 = '#ffa500',
    w1 = 'rgba(255, 127, 0, 0.3)',
    P1 = '#0afa04',
    I1 = '#5c9d31',
    b1 = 'rgba(0, 255, 0, 0.3)',
    N1 = '#ff3b30',
    B1 = 'rgba(255, 59, 48, 0.3)',
    H1 = '#e64a19',
    k1 = 'rgba(230, 74, 25, 0.3)',
    U1 = '#444',
    z1 = 'rgba(0, 0, 0, 0.3)',
    V1 = '#fff',
    F1 = 'rgba(255, 255, 255, 0.3)',
    $1 = '#ff4fa3',
    W1 = 'rgba(255, 79, 163, 0.3)',
    Y1 = '#7b34eb',
    K1 = 'rgba(123, 52, 235, 0.3)',
    X1 = '#0cc0df',
    J1 = 'rgba(12, 192, 223, 0.3)',
    Q1 = '#ff6b6b',
    j1 = '#ffa502',
    Z1 = '#ffd700',
    es = '#ff7f50',
  ...
  var {
    ...
    ci = (t, e, r) => {
      ...
      for (let i = 0; i < t; i += 1) {
        ...
        for (let f = 0; f < e; f += 1)
          d[f] = o[Math.floor(Math.random() * o.length)];
        let n = e - 3,
  ...
  var Ye = class {
      ...
      setState(e) {
        this.state = { ...this.state, ...(V(e) ? e(this.state) : e) };
      }
      resetState() {
  ...
  var li = (t) => {
    ...
    ir = li;
  var U = (t, e, r = 0) => (t.textContent = r ? F(e, r) : String(e)),
    nr = (t, e, r) => {
    ...
    Qe = class {
      ...
      update(e) {
        ...
        ((o.target = Number(e.score) || 0),
          ...
          e.lines !== i.lines && (U(r.lines, e.lines, 2), (i.lines = e.lines)),
          e.level !== i.level && (U(r.level, e.level, 2), (i.level = e.level)),
          e.combo !== i.combo && (U(r.combo, e.combo, 2), (i.combo = e.combo)));
      }
      updateController(e) {
        U(this.elements.controller, e.toUpperCase());
      }
      tick() {
        let { elements: e, scoreTracker: r, highScoreTracker: o } = this;
        (nr(r, e.score, 5), nr(o, e.highScore, 5));
      }
      reset() {
        let {
          elements: e,
  ...
  var hi = (t, e) => {
      ...
      (m.save(),
        ...
        (m.font = `${T * n}px ${E}`),
        f &&
          ((m.strokeStyle = d || i), (m.lineWidth = l), m.strokeText(r, o, s)),
        (m.fillStyle = i),
        m.fillText(r, o, s),
        p < 1 && (m.globalAlpha = 1),
        m.restore());
  ...
  var { RGBA_WHITE: Ee } = h,
    ...
    $ = gi;
  var je = new Map(),
    Si = (t) => `data:image/svg+xml;charset=utf-8,${encodeURIComponent(t)}`,
    w = (t) => {
      let e = je.get(t);
      if (e) return e;
      let r = new Image();
      return ((r.src = Si(t)), je.set(t, r), r);
    },
    Ti = () => {
      je.clear();
    },
  ...
  var Ai = (t, e) => {
      ...
      switch (e) {
        case 'main-menu':
        case 'countdown': {
          ((n = w($.tetris)), (c = o), (a = o / 2 - c / 2), (f = s - c));
          break;
        }
        case 'playing': {
          (i >= 0 && i <= 8
  ...
  var {
    ...
    Zi = {
      Teal: { stroke: qe, face: Hi, secondHand: _e },
      Violet: { stroke: Xi, face: Ji, secondHand: qe },
      Yellow: { stroke: et, face: Yi, secondHand: _e },
      Pink: { stroke: ki, face: Ui, secondHand: et },
      Purple: { stroke: Ni, face: Bi, secondHand: qe },
      Green: { stroke: _e, face: Fi, secondHand: qe },
      Blue: { stroke: $i, face: Wi, secondHand: et },
      Coral: { stroke: Pi, face: Ii, secondHand: Ze },
      Orange: { stroke: zi, face: Vi, secondHand: tt },
      Cyan: { stroke: Qi, face: ji, secondHand: _e },
      White: { stroke: Ze, face: bi, secondHand: tt },
      Red: { stroke: tt, face: Ki, secondHand: Ze },
    },
    ve = Zi;
  var en = (t, e = 'yyyy-MM-dd HH:mm:ss') => {
      let r = t.getFullYear(),
        o = t.getMonth() + 1,
        s = t.getDate(),
        i = t.getHours(),
        ...
        p = e;
      for (let E of Object.keys(l)) p = p.replaceAll(new RegExp(E, 'g'), l[E]);
      return p;
    },
    gr = en;
  var tn = (t) =>
  ...
  var En = (t, e, r, o) => {
      let { gameBoardContext: s, blockSize: i } = t,
        ...
        f = te(o, 0.15),
        l = Q(o, 0.25),
        p = s.createLinearGradient(d, n, d, n + a);
      (p.addColorStop(0, f),
        ...
        s.beginPath(),
        s.moveTo(d, n),
        s.lineTo(d + c * 0.3, n + a * 0.5),
        s.lineTo(d, n + a),
        s.fill(),
        (s.fillStyle = 'rgba(0, 0, 0, 0.06)'),
        s.beginPath(),
        s.moveTo(d + c, n),
        s.lineTo(d + c * 0.7, n + a * 0.5),
        s.lineTo(d + c, n + a),
        s.fill());
    },
    Dr = En;
  var K = (t) => {
    ...
    wr = (t) => {
      ...
      (K({ ctx: e, px: r, py: o, w: s, h: i, u: d, steps: 0, color: c }),
        K({ ctx: e, px: r, py: o, w: s, h: i, u: d, steps: 1, color: n }),
        K({ ctx: e, px: r, py: o, w: s, h: i, u: d, steps: 2, color: c }));
    },
    qn = (t, e, r, o, s = 'square') => {
      ...
      switch (s) {
        case 'jay': {
          (wr({
            ...
            K({ ctx: i, px: c, py: a, w: f, h: l, u: n, steps: 3, color: E }));
          break;
        }
        case 'ell': {
          (K({ ctx: i, px: c, py: a, w: f, h: l, u: n, steps: 0, color: p }),
            K({ ctx: i, px: c, py: a, w: f, h: l, u: n, steps: 1, color: o }));
          break;
        }
        case 'tee': {
          (K({ ctx: i, px: c, py: a, w: f, h: l, u: n, steps: 0, color: p }),
            K({ ctx: i, px: c, py: a, w: f, h: l, u: n, steps: 1, color: o }),
            (i.fillStyle = E),
            i.fillRect(c + n * 2, a + n * 2, n, l - n * 4),
            i.fillRect(c + n * 2, a + n * 2, f - n * 4, n),
            (i.fillStyle = p),
            i.fillRect(c + n * 2, a + n * 5, f - n * 4, n),
            i.fillRect(c + n * 5, a + n * 3, n, l - n * 6));
          break;
        }
        default:
          wr({
  ...
  var Tn = {
    ...
    An = (t) => {
      let { gameBoard: e } = t,
        ...
        n = Ln(s),
        c = Tn[n],
        { size: a, x: f, y: l } = c(r, o);
      Y(t, { img: d, x: f, y: l, size: a });
    },
    Br = An;
  var Rn = (t, e) => {
      let { rows: r, cols: o } = t;
      (O(t), Br(t), G(t, 'playing'));
      for (let s = 0; s < r; s++)
        for (let i = 0; i < o; i++) e[s][i] && I(t, i, s, e[s][i]);
    },
    Hr = Rn;
  var Cn = (t, e, r, o) => {
      let { shape: s, color: i } = e,
        { length: d } = s;
      for (let n = 0; n < d; n++)
        for (let c = 0; c < s[n].length; c++) s[n][c] && I(t, r + c, o + n, i);
      return !0;
    },
    kr = Cn;
  var xn = (t, e) => {
    ...
    re = xn;
  var On = (t, e) => {
      (O(t), re(t, e), M(t), G(t, 'paused'), y(t), Sr(t), Mr(t), vr(t));
    },
    Ur = On;
  var yn = (t, e) => {
      Ur(t, e);
  ...
  var Gn = (t) => {
    ...
    Te = Gn;
  var Dn = (t, e) => {
      (O(t), re(t, e), M(t), G(t, 'game-over'), y(t), Se(t), Te(t), ee(t));
    },
    Vr = Dn;
  var wn = (t, e) => {
      Vr(t, e);
  ...
  var In = (t, e) => {
      ...
      let { shape: a } = r,
        f = Math.ceil(n / 6),
        l = Math.floor((n - a[0].length * f) / 2),
        p = Math.floor((c - a.length * f) / 2);
      (Le(t), d.save(), d.translate(l, p));
  ...
  var Nn = (t, e) => {
      ...
      let { shape: a } = r,
        ...
        l = Math.floor((n - a[0].length * f) / 2),
        p = Math.floor((c - a.length * f) / 2);
      (Re(t), o.save(), o.translate(l, p));
      for (let E = 0; E < a.length; E++)
        for (let m = 0; m < a[E].length; m++)
          a[E][m] &&
            I(
              { gameBoardContext: o, blockSize: f, style: i, pattern: d },
              m,
              E,
              r.color,
            );
  ...
  var Hn = (t, e) => {
    ...
    $r = Hn;
  var kn = (t, e) => {
      (O(t), xe(t, e), M(t), G(t, 'game-over'), y(t), Se(t), Te(t), ee(t));
    },
    Wr = kn;
  var Un = (t, e) => {
      Wr(t, e);
  ...
  var $n = (t, e) => {
      ...
      for (let c = 0; c < d.length; c++)
        for (let a = 0; a < d[c].length; a++) d[c][a] && I(t, s + a, i + c, n);
      r.globalAlpha = 1;
    },
    Jr = $n;
  var Wn = (t) => {
      ...
      if (d >= 480) {
        let p = n * 0.9;
        ((c = Math.floor(p / s)), (a = f = Math.min(d * 0.1, n * 0.18)));
      } else {
        let p = d * 0.64;
        ((c = Math.min(Math.floor(p / i), Math.floor((n * 0.68) / s))),
          (a = f = c * 5));
      }
      let l = Math.floor(c * s * 0.032);
      ((t.blockSize = c),
        (e.width = c * i),
        (e.height = c * s),
        (t.fontSize = l),
  ...
  var Yn = (t, e) => {
      ...
      for (let s of e.lines) {
        ...
        for (let i = 0; i < o; i++) I(t, i, s.y, s.color);
        r.restore();
      }
    },
    jr = Yn;
  var Kn = (t, e) => {
      let { WHITE: r, YELLOW: o } = h,
        { gameBoard: s, blockSize: i } = t,
        { width: d } = s,
        { score: n, y: c, alpha: a, offsetY: f, combo: l, comboScore: p } = e;
      if (a <= 0) return;
      let E = d / 2,
        m = c * i + i / 2 - f;
      (l > 1 &&
  ...
  var Xn = (t, e, r = 1) => {
      ...
      (n.save(),
        ...
        (n.lineWidth = 6));
      let l = String(e);
      (n.strokeText(l, 0, 0), n.fillText(l, 0, 0), n.restore());
    },
    eo = Xn;
  var Jn = (t) => {
      let { GREEN: e, BLACK: r } = h,
        { gameBoard: o } = t,
        { width: s, height: i } = o;
      S(t, {
        text: 'GET READY!',
  ...
  var Qn = (t) => {
      let { gameBoard: e } = t,
        ...
        d = r / 2 - i / 2,
        n = o / 2 - i * 1.2;
      Y(t, { img: s, x: d, y: n, size: i });
    },
    ro = Qn;
  var jn = (t, e) => {
      let { number: r, scale: o } = e;
      (O(t), M(t), y(t), G(t, 'countdown'), ro(t), to(t), eo(t, r, o));
    },
    oo = jn;
  var Zn = (t, e) => {
      let { gameBoardContext: r } = t;
  ...
  function r2(t, e, r) {
    let { gameBoard: o } = t,
      { height: s } = o;
    (M(t), y(t), io(t), pe(t, e, s / 1.85), no(t), so(t, r));
  }
  var co = r2;
  var o2 = (t, e) => {
      if (!e) return;
  ...
  var rt = class extends _ {
      ...
      initialize() {
        let { Game: e, Elements: r, Block: o } = this,
          { Hud: s, Canvas: i } = r;
        ((this.Hud = new dr(s)),
          (this.Canvas = new sr({ uuid: e.id, ...i, ...o })));
      }
      updateMode(e) {
  ...
  var st = class extends _ {
      ...
      initialize(e) {
        let { Game: r } = this;
        ((this.Renderer = new fo(e)),
          (this.Router = new lo({ UI: this, Game: r })));
      }
      updateMode(e) {
  ...
  var k = {
    ...
    dt = class extends _ {
      ...
      _onConnect = (e) => {
        ...
        ((this.activeGamepadIndex = r.index),
          (this.curBtnMap = this._isBetop(r.id) ? qo : nt));
        let { Game: o } = this,
          s = u(o.id);
      ...
      _handleStandardButtons(e, r, o, s) {
        let i = this._isBetop(e.id),
          { Game: d, Store: n } = this,
          c = n.getController();
        for (let [a, f] of Object.entries(k)) {
          let l =
              !f ||
          ...
          if (l) return this;
          let E = this._resolveAction(f, a, p, r, o, s);
          E &&
            this.emit('dispatch:input', {
              device: 'gamepad',
              action: E,
    ...
    _o = dt;
  var Oe = { holes: -5, height: -0.3, bumpiness: -0.2, completeLines: 20 },
    i2 = {
      EASY: { lookahead: 2, noise: 0.25, weights: Oe, delay: 580 },
      NORMAL: { lookahead: 3, beam: 2, noise: 0.15, weights: Oe, delay: 480 },
      HARD: { lookahead: 4, beam: 4, noise: 0.05, weights: Oe, delay: 280 },
      EXPERT: { lookahead: 4, noise: 0, beam: 5, weights: Oe, delay: 150 },
    },
    oe = i2;
  var {
      TEAL: n2,
    ...
    E5 = [
      [n2, d2, c2, a2, f2, l2, u2, h2],
      [m2, p2, E2, q2, _2, v2, g2, S2],
      [T2, L2, A2, R2, C2, x2, O2, y2],
      [M2, G2, D2, w2, P2, I2, b2, N2],
      [B2, H2, k2, U2, z2, V2, F2, $2],
      [W2, Y2, K2, X2, J2, Q2, j2, Z2],
      [e5, t5, r5, o5, s5, i5, n5, d5],
      [c5, a5, f5, l5, u5, h5, m5, p5],
    ],
    ct = E5;
  var q5 = [
  ...
  var ft = !0,
    vo = () => {
      let t = [...at].toSorted(() => Math.random() - 0.5);
      if (ft)
        for (; [3, 6, 7].includes(t[0].colorIndex); )
          t = [...at].toSorted(() => Math.random() - 0.5);
      return ((ft = !1), t);
    };
  vo._reset = () => {
    ft = !0;
  ...
  var ye = [],
    _5 = (t = 1) => {
      ye.length === 0 && (ye = go());
      let e = ye.pop(),
        r = Math.min(Math.floor((t - 1) / 32), ct.length - 1),
        o = ct[r];
      return {
  ...
  var R5 = (t, e, r) => {
      let o = 0;
      for (; !Ro(t, e, r, o + 1); ) o += 1;
      return { board: Me(t, e, r, o), y: o };
    },
    xo = R5;
  var C5 = (t, e) => {
  ...
  var x5 = (t, e) => {
    ...
    yo = x5;
  var O5 = ({ rotationCount: t, targetX: e, originalX: r }) => {
      let o = [];
      return (Oo(o, t), yo(o, e - r), o.push('DROP'), o);
    },
    Mo = O5;
  var y5 = ({
      board: t,
      ...
      let i = xo(t, e, r),
        d = Mo({ rotationCount: s, targetX: r, originalX: o.position.x });
      return { board: i.board, actions: d };
    },
    Go = y5;
  var M5 = (t, e, r = !1) => {
      let o = [],
      ...
      for (let i = 0; i < 4; i++) {
        ...
        for (let n of d) {
          ...
          (r && (c.actions = ['HOLD', ...c.actions]), o.push(c));
        }
        s = Lo(s);
      }
      return o;
  ...
  var P5 = (t, e, r) => {
      ...
      for (let T = 0; T < t[0].length; T++) o.push(wo(t, T));
  ...
  var N5 = (t, e) => {
    ...
    j = N5;
  var B5 = (t, e) => {
      let r = Me(t.board, t.piece.shape, t.piece.position.x, e.y),
        o = se(r),
        s = j(o, t),
        i = t.bag ? [...t.bag] : [],
        d =
  ...
  var bo = (t, e, r = 1, o = 5) => {
      ...
      for (let n of s) {
        ...
        (n.actions.includes('HOLD') && (c += 2), c > d && ((d = c), (i = n)));
      }
      return i;
    },
    No = bo;
  var ht = class extends _ {
      ...
      think(e) {
        let r = this.getDifficultyConfig(),
          { lookahead: o, weights: s, beam: i } = r,
          d = To(e);
        return No(d, s, o, i);
      }
      getDifficultyConfig() {
      ...
      subscribe() {
        let { Game: e } = this,
          r = e.id,
          o = H(r);
        (this.on(o.START, this._onStart), this.on(o.STOP, this._onStop));
      }
      unsubscribe() {
        let { Game: e } = this,
          r = e.id,
          o = H(r);
        (this.off(o.START, this._onStart), this.off(o.STOP, this._onStop));
      }
      _onStart = () => {
        this.start();
      };
  ...
  var Et = class extends _ {
      ...
      initialize() {
        ((this.recording = !1),
          ...
          (this.timestamp = 0));
        let { Game: e } = this;
        this.Router = new Uo({ Replay: this, Game: e });
      }
      getNextPiece() {
      ...
      update({ speed: e, timestamp: r }) {
        ...
        if (c) {
          let a = e ?? 1e3,
            f = c.ms - this.playElapsed;
          if (f > a * 2) {
            let l = Math.min(f - a, 1e3);
            ((this.playElapsed += l), (this.startTime = r - this.playElapsed));
          }
        }
        for (
          ;
  ...
  var U5 = (t, e) => {
    ...
    $o = U5;
  var z5 = (t) => Array.from({ length: t }).fill(0),
    V5 = (t) => {
      let { MAX_LEVEL: e, CLEAR_LINE_SCORES: r, ALL_CLEAR_SCORE: o = 2e3 } = x,
        { Elements: s, Store: i } = t,
        d = i.getState(),
        { cols: n } = s.Canvas,
        c = [...(d.clearLines || [])].toSorted((B, ke) => ke - B),
        a = c.length,
        f = structuredClone(d.board);
      for (let B of c) f.splice(B, 1);
      for (let B = 0; B < a; B++) f.unshift(z5(n));
      let l = d.lines + a,
        p = d.baseLines + l,
        { level: E, levelUpSteps: m } = $o(p, e),
        T = E > d.level,
        ...
        I0 = X ? 1.5 : 1,
        b0 = W,
        Rt = a > 0 && f.every((B) => B.every((ke) => ke === 0)),
        N0 = Rt ? o : 0,
        B0 = D || r[a] || 0,
        Be = Math.floor(B0 * I0 * E),
        le = a > 0 ? (d.combo || 0) + 1 : 0,
        He = le > 1 ? (le - 1) * 50 : 0;
      return {
        stateHandler: (B) => ({
          ...B,
  ...
  var vt = class extends _ {
      ...
      initialize(e) {
        ...
        let { clearScore: c, combo: a, comboScore: f } = fe(s),
          l = () => {
  ...
  var F5 = (t) => {
      ...
      let o = r.getState(),
        { next: s, level: i } = o;
      return {
        curr: s ? { ...s, shape: s.shape.map((n) => [...n]) } : lt(i),
        next: lt(i),
      };
    },
    Jo = F5;
  ...
  var s4 = (t) => (t === 'I' ? s0 : t === 'I5' ? i0 : t === 'O' ? null : n0),
    d0 = s4;
  var i4 = (t, e) => ((t ?? 0) + e + 4) % 4,
    c0 = i4;
  var n4 = (t) => {
      let e = t.length,
        r = t[0].length,
  ...
  var l4 = (t, e, r, o, s) => {
      ...
      for (let [n, c] of s) {
        let a = n,
          f = -c;
        if (!z(t, a, f, r))
          return (Pe(t.Store, e, r, o, i + a, d + f), Ie(t), !0);
      }
      return !1;
    },
    u0 = l4;
  var u4 = (t, e, r, o) =>
      z(t, 0, 0, r) ? !1 : (Pe(t.Store, e, r, o), Ie(t), !0),
    h0 = u4;
  var h4 = (t, e = 1) => {
      let { Store: r } = t,
        { curr: o } = r.getState();
      ...
      for (let n = 0; n < s.length; n++)
        for (let c = 0; c < s[n].length; c++)
          if (s[n][c]) {
            let a = r.cy + n,
              f = r.cx + c;
            if (a < 0 || a >= i.length || f < 0 || f >= i[0].length) continue;
            i[a][f] = o.color;
          }
      let d = p0(t);
  ...
  var g4 = (t) => {
      ...
      let d = g(),
        n = u(t.id),
        { curr: c, cx: a, cy: f } = t.Store.getState();
      (be(t),
        t.emit(n.START_LANDING_FLASH, {
          piece: { shape: c.shape, cx: a, cy: f },
        }),
  ...
  var T4 = (t) => {
    ...
    g0 = T4;
  var L4 = (t) => localStorage.getItem(t),
    S0 = L4;
  var A4 = (t, e) => {
  ...
  var Lt = class extends _ {
      ...
      initialize() {
        let { Elements: e, Block: r, Scheduler: o } = this,
          { Controls: s } = e,
          i = new tr({ ...e.Canvas, GameState: jt });
        ((this.id =
          crypto?.randomUUID?.() ||
          `${Date.now()}-${Math.random().toString(36).slice(2, 10)}`),
          (this.effect = null),
          (this.Store = i),
          (this.Animations = new or({ Game: this })),
          (this.CommandQueue = new rr({ Game: this })),
          (this.AI = new Bo({
            Game: this,
            Store: i,
            Scheduler: o,
          ...
          (this.UI = new uo({ Game: this, Store: i, Elements: e, Block: r })),
          (this.Keyboard = new po({ Game: this, Store: i })),
          (this.Gamepad = new _o({ Game: this, Store: i })),
          (this.Touch = new ko({ Game: this, Store: i, Controls: s })),
          (this.Replay = new zo({ Game: this, Store: i, Scheduler: o })),
          (this.Router = new Qt({
            Animations: this.Animations,
            AI: this.AI,
      ...
      loadHighScore() {
        let e = Number.parseInt(S0('tetris-high-score'), 10) || 0;
        this.Store.setHighScore(e);
      }
      saveHighScore(e) {
        let { Store: r } = this;
        e > r.getHighScore() &&
          (r.setHighScore(e), T0('tetris-high-score', e.toString()));
      }
      begin() {
        Qo(this);
      }
      ...
      startCountdown() {
        let { Scheduler: e } = this;
        this.Animations.register(new Vo({ Scheduler: e, Game: this }));
      }
      startPaused() {
        let { Scheduler: e } = this;
      ...
      startClearLines(e) {
        ...
        this.Animations.register(
          new Wo({ Game: this, Store: o, Scheduler: r, lines: e }),
        );
      }
      startClearScore(e) {
        let { Scheduler: r } = this;
        this.Animations.register(
          new Yo({ Game: this, scoreData: e, Scheduler: r }),
        );
      }
      startLevelUp(e) {
        let { Scheduler: r, UI: o } = this;
        this.Animations.register(
          new Ko({ Game: this, UI: o, level: e, Scheduler: r }),
        );
      }
      startLandingFlash(e) {
        let { Scheduler: r } = this;
        this.Animations.register(
          new Xo({ Game: this, piece: e, Scheduler: r }),
        );
      }
      addEventListeners() {
  ...
  var R4 = (t, e) => {
      ...
      let { Game: d } = o,
        ...
        a = J(c),
        f = C(c);
      (d.emit(a.ENQUEUE, { cmd: n }), d.emit(f.ADD_RECORD, { ms: i, cmd: n }));
    },
    R0 = R4;
  var C4 = {
      LEVEL_ONE: (t) => {
  ...
  var q = {
      ...
      initialize: (t) => {
        ...
        ((q.Audio = new Jt(e)), (q.Game = new L0(e)));
      },
      launch: () => {
      ...
      tick: (t) => {
        ...
        ((q.lastTickTime = t),
          ...
          d.update(),
          c.flush(),
          (!q.fixedAccumulator || f > e.getSpeed()) &&
            !s.playing &&
