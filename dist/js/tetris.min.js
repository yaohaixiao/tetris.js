var tetris = (() => {
  ...
  var _0 = (r, e, t, o = {}) => {
    ...
    T = _0;
  var v0 = (r, e = !1) => (e ? 'perfect' : r === 4 ? 'tetris' : 'combo'),
    Je = class extends q {
      constructor(e) {
        super(e);
      }
      ...
      CLEAR = (e = 1, t = 1, o = !1) => {
        let s = Math.min(Math.floor((t - 1) / 16), 15),
          ...
          p = i[u].filter((w) => w > 0).map((w) => w + h.shift * 12),
          A = [],
          { Context: R, Scheduler: L } = this;
        for (let [w, J] of p.entries())
          A.push({
            fn: () => {
              let Z = R.currentTime;
  ...
  var S0 = [
    ...
    T0 = [0, 100, 300, 500, 800, 1200],
    A0 = '"Press Start 2P", monospace, sans-serif',
    R0 = 256,
    L0 = {
      CLEAR_LINE_SCORES: T0,
      FONT_FAMILY: A0,
      AI_ALLOWED_ACTIONS: S0,
      MAX_LEVEL: R0,
    },
    x = L0;
  var C0 = {
  ...
  var U0 = {
    ...
    ar = U0;
  var z0 = [Ft, Yt, Kt, Xt, Jt, jt, Qt, Zt, er, tr, rr, or, sr, ir, nr, ar],
    je = z0;
  var $0 = 0.12,
    V0 = 25,
    W0 = (r, e, t = {}) => {
      ...
      r.bgmSchedulerId = d.interval(E, V0);
    },
    dr = W0;
  var F0 = (r, e) => {
      let { length: t } = je,
    ...
    Y0 = (r, e = 1) => {
      ...
      dr(r, o, { duration: s, volume: i, wave: n, gate: a, articulation: d });
    },
    qe = Y0;
  var K0 = (r) => {
    ...
    ge = K0;
  var X0 = (r, e) => {
      r.bgmSchedulerId === 0 ? qe(r, e) : ge(r);
    },
    cr = X0;
  var de = (r) => ({ CLEAR: `animations:${r}:clear` }),
    v = () => ({
  ...
  var Qe = class extends q {
      ...
      initialize(e) {
        ...
        ((this.Context = t),
          (this.Sounds = new Wt({ ...e, Context: t })),
          (this.bgmSchedulerId = 0));
      }
      playBGM(e) {
        this.bgmSchedulerId === 0 && qe(this, e);
      }
      stopBGM() {
        ge(this);
      }
  ...
  var Ze = class extends q {
      ...
      _onStartGarbagePush = (e) => {
        let { Game: t } = this,
          { rows: o } = e;
        (console.log('START_GARBAGE_PUSH'), t.startGarbagePush(o));
      };
    },
    fr = Ze;
  var J0 = {
    ...
    hr = J0;
  var j0 = '#00c8ff',
    Q0 = 'rgba(0, 200, 255, 0.3)',
    Z0 = '#f1fa04',
    ei = 'rgba(255, 255, 0, 0.3)',
    ti = '#d31ac1',
    ri = 'rgba(211, 26, 193, 0.3)',
    oi = '#5050ff',
    si = 'rgba(80, 80, 255, 0.3)',
    ii = '#ffa500',
    ni = 'rgba(255, 127, 0, 0.3)',
    ai = '#0afa04',
    di = '#5c9d31',
    ci = 'rgba(0, 255, 0, 0.3)',
    li = '#ff3b30',
    fi = 'rgba(255, 59, 48, 0.3)',
    hi = '#e64a19',
    ui = 'rgba(230, 74, 25, 0.3)',
    mi = '#444',
    pi = 'rgba(0, 0, 0, 0.3)',
    Ei = '#fff',
    qi = 'rgba(255, 255, 255, 0.3)',
    gi = '#ff4fa3',
    _i = 'rgba(255, 79, 163, 0.3)',
    vi = '#7b34eb',
    Si = 'rgba(123, 52, 235, 0.3)',
    Ti = '#0cc0df',
    Ai = 'rgba(12, 192, 223, 0.3)',
    Ri = '#ff6b6b',
    Li = '#ffa502',
    Ci = '#ffd700',
    xi = '#ff7f50',
  ...
  var V = (r, e, t = 0) => (r.textContent = t ? K(e, t) : String(e)),
    ...
    st = class {
      ...
      tick() {
        ...
        (vr(t, e.score, 5), vr(o, e.highScore, 5));
      }
      reset() {
        let {
          elements: e,
  ...
  var { RGBA_WHITE: ve } = f,
    ...
    X = Kn;
  var it = new Map(),
    Xn = (r) => `data:image/svg+xml;charset=utf-8,${encodeURIComponent(r)}`,
    I = (r) => {
      let e = it.get(r);
      if (e) return e;
      let t = new Image();
      return ((t.src = Xn(r)), it.set(r, t), t);
    },
    Jn = () => {
      it.clear();
    },
  ...
  var Qn = (r, e) => {
      ...
      switch (e) {
        case 'main-menu':
        case 'countdown': {
          ((a = I(X.tetris)), (d = o), (c = o / 2 - d / 2), (l = s - d));
          break;
        }
        case 'playing': {
          (i >= 0 && i <= 8
  ...
  var {
    ...
    x1 = {
      Teal: { stroke: Se, face: u1, secondHand: Te },
      Violet: { stroke: A1, face: R1, secondHand: Se },
      Yellow: { stroke: dt, face: S1, secondHand: Te },
      Pink: { stroke: m1, face: p1, secondHand: dt },
      Purple: { stroke: f1, face: h1, secondHand: Se },
      Green: { stroke: Te, face: g1, secondHand: Se },
      Blue: { stroke: _1, face: v1, secondHand: dt },
      Coral: { stroke: d1, face: c1, secondHand: at },
      Orange: { stroke: E1, face: q1, secondHand: ct },
      Cyan: { stroke: L1, face: C1, secondHand: Te },
      White: { stroke: at, face: l1, secondHand: ct },
      Red: { stroke: ct, face: T1, secondHand: at },
    },
    Ae = x1;
  var y1 = (r, e = 'yyyy-MM-dd HH:mm:ss') => {
      let t = r.getFullYear(),
        o = r.getMonth() + 1,
        s = r.getDate(),
        i = r.getHours(),
        ...
        u = e;
      for (let E of Object.keys(h)) u = u.replaceAll(new RegExp(E, 'g'), h[E]);
      return u;
    },
    Pr = y1;
  var G1 = (r) =>
  ...
  var $1 = (r, e, t, o) => {
      ...
      for (let u = 0; u < a * a * 0.3; u++) {
        let E = d + ((h + u * 7) % a),
          p = c + ((h + u * 11) % a),
          A = 0.03 + ((h + u * 3) % 8) * 0.01;
        ((s.fillStyle = W('#FFFFFF', A)), s.fillRect(E, p, 1, 1));
      }
      (s.restore(),
  ...
  var Q = (r) => {
    ...
    X1 = (r, e, t, o, s = 'square') => {
      ...
      switch (s) {
        case 'jay': {
          (Jr({ ctx: i, px: d, py: c, w: l, h, u: a, color: o, darkColor: u }),
            Q({ ctx: i, px: d, py: c, w: l, h, u: a, steps: 3, color: E }));
          break;
        }
        case 'ell': {
          (Q({ ctx: i, px: d, py: c, w: l, h, u: a, steps: 0, color: u }),
  ...
  var o2 = (r, e) => {
      let { rows: t, cols: o } = r;
      (G(r), to(r), M(r, 'playing'));
      for (let s = 0; s < t; s++)
        for (let i = 0; i < o; i++) e[s][i] && P(r, i, s, e[s][i]);
    },
    ro = o2;
  var s2 = (r, e, t, o) => {
      let { shape: s, color: i } = e,
        { length: n } = s;
      for (let a = 0; a < n; a++)
        for (let d = 0; d < s[a].length; d++) s[a][d] && P(r, t + d, o + a, i);
      return !0;
    },
    oo = s2;
  var i2 = (r, e) => {
    ...
    oe = i2;
  var n2 = (r, e) => {
      (G(r), oe(r, e), b(r), M(r, 'paused'), O(r), wr(r), $r(r), Mr(r));
    },
    so = n2;
  var a2 = (r, e) => {
      so(r, e);
  ...
  var c2 = (r) => {
    ...
    Ce = c2;
  var l2 = (r, e) => {
      (G(r), oe(r, e), b(r), M(r, 'game-over'), O(r), Le(r), Ce(r), re(r));
    },
    no = l2;
  var f2 = (r, e) => {
      no(r, e);
  ...
  var u2 = (r, e) => {
      ...
      let { shape: c } = t,
        ...
        u = Math.floor((d - c.length * l) / 2);
      (xe(r), n.save(), n.translate(h, u));
  ...
  var q2 = (r, e) => {
    ...
    co = q2;
  var g2 = (r, e) => {
      (G(r), be(r, e), b(r), M(r, 'game-over'), O(r), Le(r), Ce(r), re(r));
    },
    lo = g2;
  var _2 = (r, e) => {
      lo(r, e);
  ...
  var A2 = (r, e) => {
      ...
      for (let d = 0; d < n.length; d++)
        for (let c = 0; c < n[d].length; c++) n[d][c] && P(r, s + c, i + d, a);
      t.globalAlpha = 1;
    },
    mo = A2;
  var R2 = (r) => {
      ...
      if (n >= 480) {
        let u = a * 0.9;
        ((d = Math.floor(u / s)), (c = l = Math.min(n * 0.1, a * 0.18)));
      } else {
        let u = n * 0.64;
        ((d = Math.min(Math.floor(u / i), Math.floor((a * 0.68) / s))),
          (c = l = d * 5));
      }
  ...
  var L2 = (r, e) => {
      ...
      for (let s of e.lines) {
        ...
        for (let i = 0; i < o; i++) P(r, i, s.y, s.color);
        t.restore();
      }
    },
    Eo = L2;
  var C2 = (r, e) => {
      let { WHITE: t, YELLOW: o } = f,
        ...
        { width: n } = s,
        { score: a, y: d, alpha: c, offsetY: l, combo: h, comboScore: u } = e;
      if (c <= 0) return;
      let E = n / 2,
        p = d * i + i / 2 - l;
      (h > 1 &&
  ...
  var O2 = (r, e) => {
      ...
      (G(r), b(r), O(r), M(r, 'countdown'), vo(r), _o(r), go(r, t, o));
    },
    So = O2;
  var b2 = (r, e) => {
      let { gameBoardContext: t } = r;
  ...
  function w2(r, e, t) {
    let { gameBoard: o } = r,
      { height: s } = o;
    (b(r), O(r), Ao(r), _e(r, e, s / 1.85), Ro(r), To(r, t));
  }
  var Lo = w2;
  var B2 = (r, e) => {
      if (!e) return;
  ...
  var I2 = (r) => {
      let { ORANGE: e } = f,
        { gameBoardContext: t, blockSize: o, rows: s, cols: i } = r,
        n = i * o,
        a = s * o;
      ((t.globalAlpha = 0.15),
        (t.fillStyle = e),
        ...
        (t.lineWidth = 1));
      for (let l = 0; l <= i; l++)
        (t.beginPath(), t.moveTo(l * o, 0), t.lineTo(l * o, a), t.stroke());
      for (let l = 0; l <= s; l++)
        (t.beginPath(), t.moveTo(0, l * o), t.lineTo(n, l * o), t.stroke());
      t.globalAlpha = 1;
      let d = n / 2,
        c = a / 2;
      (S(r, {
  ...
  var lt = class extends q {
      ...
      initialize() {
        let { Game: e, Elements: t, Block: o, Player: s } = this,
          { Hud: i, Canvas: n } = t;
        ((this.Hud = new Sr({ Hud: i, Player: s })),
          (this.Canvas = new gr({ uuid: e.id, ...n, ...o, ...s })));
      }
      updateMode(e) {
      ...
      lazyRender() {
        let { Store: e } = this;
        uo(this.Canvas, e.getState());
      }
      render() {
        let { Store: e } = this;
        ce(this.Canvas, e.getState());
      }
      resize() {
        po(this.Canvas);
      }
  ...
  var ht = class extends q {
      ...
      initialize(e) {
        let { Game: t } = this;
        ((this.Renderer = new Go(e)),
          (this.Router = new Oo({ UI: this, Game: t })));
      }
      updateMode(e) {
  ...
  var $ = {
      ...
      _onConnect = (e) => {
        ...
        if (this.boundGamepadIndex !== null) {
          ...
          ((this.activeGamepadIndex = t.index),
            (this.curBtnMap = this._isBetop(t.id) ? Me : le));
          let { Game: i } = this,
            n = m(i.id);
          return (
      ...
      _refreshGamepadState() {
        ...
        if (this.boundGamepadIndex !== null)
          return (
            ...
            this.activeGamepad &&
              (this.curBtnMap = this._isBetop(this.activeGamepad.id) ? Me : le),
            this
          );
    ...
    Pe = mt;
  var we = { holes: -5, height: -0.3, bumpiness: -0.2, completeLines: 20 },
    k2 = {
      EASY: { lookahead: 2, noise: 0.15, weights: we, delay: 580 },
      NORMAL: { lookahead: 3, beam: 2, noise: 0.08, weights: we, delay: 480 },
      HARD: { lookahead: 4, beam: 4, noise: 0.04, weights: we, delay: 280 },
      EXPERT: { lookahead: 4, noise: 0, beam: 5, weights: we, delay: 150 },
    },
    se = k2;
  var H2 = [
  ...
  var qt = !0,
    Io = () => {
      let r = [...Et].toSorted(() => Math.random() - 0.5);
      if (qt)
        for (; [3, 6, 7].includes(r[0].colorIndex); )
          r = [...Et].toSorted(() => Math.random() - 0.5);
      return ((qt = !1), r);
    };
  Io._reset = () => {
    qt = !0;
  ...
  var Be = [],
    z2 = (r = 1) => {
      Be.length === 0 && (Be = Do());
      let e = Be.pop(),
        t = Math.min(Math.floor((r - 1) / 32), pt.length - 1),
        o = pt[t];
      return {
  ...
  var X2 = (r, e) => {
    ...
    Wo = X2;
  var J2 = ({ rotationCount: r, targetX: e, originalX: t }) => {
      let o = [];
      return (Vo(o, r), Wo(o, e - t), o.push('DROP'), o);
    },
    Fo = J2;
  var j2 = ({
      board: r,
      ...
      let { y: i, placeOn: n } = $o(r, e, t),
        a = Fo({ rotationCount: s, targetX: t, originalX: o.position.x });
  ...
  var r5 = (r, e, t) => {
      ...
      for (let A = 0; A < r[0].length; A++) o.push(Xo(r, A));
  ...
  var a5 = (r, e) => {
    ...
    ie = a5;
  var d5 = (r, e) => {
      let t = jo(r.board, r.piece.shape, r.piece.position.x, e.y),
        o = ue(t),
        s = ie(o, r),
        i = r.bag ? [...r.bag] : [],
        n =
  ...
  var At = class extends q {
      ...
      initialize() {
        ((this.recording = !1),
          ...
          (this.timestamp = 0));
        let { Game: e } = this;
        this.Router = new ss({ Replay: this, Game: e });
      }
      getNextPiece() {
  ...
  var h5 = (r) => Array.from({ length: r }).fill(0),
    u5 = (r) => {
      ...
      let h = n.lines + c,
        ...
        d0 = Z ? 1.5 : 1,
        c0 = J,
        kt = c > 0 && l.every((U) => U.every((Ye) => Ye === 0)),
        l0 = kt ? o : 0,
        f0 = w || t[c] || 0,
        We = Math.floor(f0 * d0 * E),
        pe = c > 0 ? (n.combo || 0) + 1 : 0,
        Fe = pe > 1 ? (pe - 1) * 50 : 0;
      return {
        stateHandler: (U) => ({
          ...U,
  ...
  var Ct = class extends q {
      ...
      initialize(e) {
        ...
        let { clearScore: d, combo: c, comboScore: l } = me(s),
          h = () => {
  ...
  var Ot = class extends q {
      ...
      render() {
        ...
        let { Game: e } = this,
          t = _(e.id);
        this.emit(t.RENDER_GARBAGE_WARNING);
      }
    },
    us = Ot;
  var bt = class extends q {
      ...
      render() {
        let { Game: e, _rows: t, _visible: o } = this,
          s = _(e.id);
        this.emit(s.RENDER_GARBAGE_PUSH, { rows: t, visible: o });
      }
    },
    ms = bt;
  var m5 = (r) => {
      ...
      let o = t.getState(),
        { next: s, level: i } = o;
      return {
        curr: s ? { ...s, shape: s.shape.map((a) => [...a]) } : gt(i),
        next: gt(i),
      };
    },
    ps = m5;
  var p5 = (r, e, t, o) => {
      let { Elements: s, Store: i } = r,
        ...
        d = i.getState(),
        { curr: c, cx: l, cy: h, board: u } = d;
      if (!c) return !1;
      let E = o || c.shape;
      for (let p = 0; p < E.length; p++)
        for (let A = 0; A < E[p].length; A++)
          if (E[p][A]) {
            let R = l + A + e,
              L = h + p + t,
              w = R < 0 || R >= a || L >= n,
  ...
  var A5 = (r) => {
      ...
      let o = B();
      t === 'playing'
        ? (Ne(r), r.isVersus() && r.emit(o.SYNC_PAUSE, { from: r }))
        : (ke(r), r.isVersus() && r.emit(o.SYNC_RESUME, { from: r }));
    },
    gs = A5;
  var R5 = (r, e = 'main-menu') => {
      let { id: t, Store: o } = r,
        s = v(),
        i = z(t),
        n = de(t),
      ...
      (r.emit(s.STOP_BGM),
        ...
        r.emit(i.STOP));
      let u = r.isVersus() ? o.getController() : 'human';
      (o.setController(u),
        r.emit(c.UPDATE_CONTROLLER, { controller: u }),
        r.emit(d.RESET),
        u === 'ai' && r.emit(i.START));
    },
    He = R5;
  ...
  var y5 = (r) => (r === 'I' ? Ss : r === 'I5' ? Ts : r === 'O' ? null : As),
    Rs = y5;
  var G5 = (r, e) => ((r ?? 0) + e + 4) % 4,
    Ls = G5;
  var O5 = (r) => {
      let e = r.length,
        t = r[0].length,
  ...
  var B5 = (r, e, t, o, s) => {
      ...
      for (let [a, d] of s) {
        let c = a,
          l = -d;
        if (!F(r, c, l, t))
          return (Ue(r.Store, e, t, o, i + c, n + l), ze(r), !0);
      }
      return !1;
    },
    Gs = B5;
  var I5 = (r, e, t, o) =>
      F(r, 0, 0, t) ? !1 : (Ue(r.Store, e, t, o), ze(r), !0),
    Os = I5;
  var D5 = (r, e = 1) => {
      let { Store: t } = r,
        { curr: o } = t.getState();
  ...
  var F5 = (r) => {
    ...
    Ds = F5;
  var Y5 = (r) => localStorage.getItem(r),
    Ns = Y5;
  var K5 = (r, e) => {
  ...
  var Mt = class extends q {
      ...
      initialize() {
        let { Elements: e, Block: t, Scheduler: o, Player: s } = this,
          { Controls: i } = e,
          n = new pr({ ...e.Canvas, Player: s, GameState: hr });
        ((this.id =
          crypto?.randomUUID?.() ||
          `${Date.now()}-${Math.random().toString(36).slice(2, 10)}`),
          (this.effect = null),
          (this.Store = n),
          (this.Animations = new qr({ Game: this, Player: s })),
          (this.CommandQueue = new Er({ Game: this, Player: s })),
          (this.UI = new bo({
            Game: this,
            Store: n,
            Elements: e,
        ...
        (((a && s.name === 'ai') || !a) &&
          ...
          (this.Keyboard = new wo({ Game: this, Store: n, Player: s })),
      ...
      _initializeGamepadController() {
        ...
        this.isVersus()
          ? t.index === 0
            ? s >= 2 &&
              ((this.Gamepad = new Pe({ Game: this, Store: e, Player: t })),
      ...
      loadHighScore() {
        let e = Number.parseInt(Ns('tetris-high-score'), 10) || 0;
        this.Store.setHighScore(e);
      }
      saveHighScore(e) {
        let { Store: t } = this;
        e > t.getHighScore() &&
          (t.setHighScore(e), ks('tetris-high-score', e.toString()));
      }
      begin() {
        Es(this);
      }
      ...
      startCountdown() {
        let { Scheduler: e } = this;
        this.Animations.register(new ns({ Scheduler: e, Game: this }));
      }
      startPaused() {
        let { Scheduler: e } = this;
        ((this.effect = new as({ Scheduler: e })),
      ...
      startClearLines(e) {
        ...
        this.Animations.register(
          new cs({ Game: this, Store: o, Scheduler: t, lines: e }),
        );
      }
      startClearScore(e) {
        let { Scheduler: t } = this;
        this.Animations.register(
          new ls({ Game: this, scoreData: e, Scheduler: t }),
        );
      }
      startLevelUp(e) {
        let { Scheduler: t, UI: o } = this;
        this.Animations.register(
          new fs({ Game: this, UI: o, level: e, Scheduler: t }),
        );
      }
      startLandingFlash(e) {
        let { Scheduler: t } = this;
        this.Animations.register(
          new hs({ Game: this, piece: e, Scheduler: t }),
        );
      }
      startGarbageWarning() {
        let { Scheduler: e } = this;
        this.Animations.register(new us({ Game: this, Scheduler: e }));
      }
      startGarbagePush(e) {
        let { Scheduler: t } = this;
        this.Animations.register(new ms({ Game: this, Scheduler: t, rows: e }));
      }
      addEventListeners() {
    ...
    Hs = Mt;
  var X5 = { running: !1, winner: null, scores: {}, pendingGarbage: {} },
    Us = X5;
  ...
  var Bt = class extends q {
      ...
      initialize() {
        let { overlay: e, winner: t } = this.elements;
        ((this.$overlay = document.querySelector(`#${e}`)),
          (this.$winner = document.querySelector(`#${t}`)));
      }
      show(e) {
        ((this.$winner.textContent = e),
  ...
  var It = class extends q {
    ...
    Ws = It;
  var J5 = { 1: 0, 2: 1, 3: 2, 4: 3, 5: 4 },
    j5 = { easy: 1, normal: 2, hard: 3, expert: 4 },
    Fs = (r) => J5[r] || 0,
    Ys = (r, e, t) => {
      if (e <= 0) return r;
      let o = r[0].length,
  ...
  var Dt = class extends q {
      ...
      initialize() {
        let { games: e, elements: t } = this,
          o = new zs({ games: e });
        ((this.store = o),
          (this.hud = new $s({ games: e, store: o })),
          (this.router = new Ws({ battle: this })),
          (this.ui = new Vs({ elements: t })),
          this.start());
      }
      start() {
        let { store: e } = this;
      ...
      over(e, t) {
        let o = m(e.id),
          s = m(t.id),
          i = { mode: 'battle-over' };
        (e.emit(o.UPDATE_MODE, i),
          t.emit(s.UPDATE_MODE, i),
          this.ui.show(e.Player?.name?.toUpperCase() || 'HUMAN'));
      }
      restart(e) {
        let t = m(e.id),
        ...
        if (n > 0) {
          ...
          a.sequence([
            ...
            },
            {
              fn: () => {
                let d = v();
                this.emit(d.PLAY_SOUND, { sound: 'GARBAGE_WARNING' });
              },
              delay: 120,
            },
          ]);
        ...
        t.sequence([
          {
            fn: () => {
              let c = m(e.id);
              e.emit(c.START_GARBAGE_PUSH, { rows: d });
            },
          },
          {
            fn: () => {
              let c = v();
              this.emit(c.PLAY_SOUND, { sound: 'GARBAGE_RECEIVED' });
            },
            delay: 120,
          },
        ]);
  ...
  var Q5 = (r) => {
      let { Elements: e, Mode: t, Players: o } = r,
        { Canvas: s, Hud: i, Controls: n, Container: a } = e,
        d = [],
        c = [...o],
    ...
    `);
      for (let [h, u] of c.entries()) {
        let E = `
      <div id="${u}-${h}-tetris-player" class="tetris-player">
        <section class="tetris-screen">
          <section id="${u}-${h}-tetris-screen-main" class="tetris-screen-main">
            <canvas id="${u}-${h}-${s.board}" data-mode="main-menu"></canvas>
          </section>
          <aside class="tetris-screen-aside">
            <section class="tetris-panel next">
              <h3 class="tetris-next-title">NEXT</h3>
              <canvas id="${u}-${h}-${s.next}" class="tetris-next-piece"></canvas>
            </section>
            <section class="tetris-panel controller">
              <p class="tetris-panel-text tetris-highlight"><span id="${u}-${h}-${i.controller}">Human</span></p>
            </section>
            <section class="tetris-panel data">
              <p class="tetris-panel-text">SCORE:<br><span id="${u}-${h}-${i.score}">00000</span></p>
              <p class="tetris-panel-text">LINE:<br><span id="${u}-${h}-${i.lines}">00</span></p>
              <p class="tetris-panel-text">LEVEL:<br><span id="${u}-${h}-${i.level}">01</span></p>
              <p class="tetris-panel-text">COMBO:<br><span id="${u}-${h}-${i.combo}">00</span></p>
              <p class="tetris-panel-text tetris-highlight">HI-SCORE:<br><span id="${u}-${h}-${i.highScore}">00000</span></p>
            </section>
            <section class="tetris-panel hold">
              <h3 class="tetris-hold-title">HOLD</h3>
              <canvas id="${u}-${h}-${s.hold}" class="tetris-hold-piece"></canvas>
            </section>
          </aside>
        </section>
        <footer class="tetris-controls">
          ...
          <section class="tetris-system-controls">
            <div id="${u}-${h}-${n.back}" data-key="back" class="tetris-system-button tetris-btn-back">BACK</div>
            <div id="${u}-${h}-${n.hold}" data-key="hold" class="tetris-system-button tetris-btn-hold">HOLD</div>
            <div id="${u}-${h}-${n.start}" data-key="start" class="tetris-system-button tetris-btn-start">START</div>
          </section>
          <section class="tetris-main-controls">
            <!-- D-PAD \u65B9\u5411\u952E\uFF08GAME BOY \u7ECF\u5178\u5341\u5B57\u952E\u5E03\u5C40\uFF09 -->
            <div class="tetris-dpad">
              <div id="${u}-${h}-${n.up}" data-key="dpad_up" class="tetris-dpad-up">\u2191</div>
              <div class="tetris-dpad-mid">
                <div id="${u}-${h}-${n.left}" data-key="dpad_left" class="tetris-dpad-left">\u2190</div>
                <div class="tetris-dpad-center"></div>
                <div id="${u}-${h}-${n.right}" data-key="dpad_right" class="tetris-dpad-right">\u2192</div>
              </div>
              <div id="${u}-${h}-${n.down}" data-key="dpad_down" class="tetris-dpad-down">\u2193</div>
            </div>
            <!-- ABXY \u52A8\u4F5C\u6309\u94AE\uFF08GAME BOY \u7ECF\u5178\u83F1\u5F62\u5E03\u5C40\uFF09 -->
            <div class="tetris-buttons">
              <div id="${u}-${h}-${n.x}" data-key="x" class="tetris-action-button tetris-button-x">X</div>
              <div id="${u}-${h}-${n.y}" data-key="y" class="tetris-action-button tetris-button-y">Y</div>
              <div id="${u}-${h}-${n.b}" data-key="b" class="tetris-action-button tetris-button-b">B</div>
              <div id="${u}-${h}-${n.a}" data-key="a" class="tetris-action-button tetris-button-a">A</div>
            </div>
          </section>
        </footer>
      </div>
    `;
        ...
        <div class="tetris-battle-score">
          <h3 class="tetris-battle-player">${h + 1}P</h3>
          <span id="${u}-${h}-tetris-battle-score" >0</span>
        </div>
      `));
      }
      l.innerHTML = d.join('');
  ...
  var g = {
      ...
      initialize: (r) => {
        ...
        (Xs(r), (g.Scheduler = new Ut()));
        let i = { ...r, Scheduler: g.Scheduler, isAIPlayer: !0 };
        g.Audio = new lr(i);
        let n = [...e];
        t === 'single' && n.pop();
        for (let [a, d] of n.entries())
          g.Games.push(new Hs({ Player: { index: a, name: d }, ...i }));
        g.isVersus() &&
          (g.Battle = new Ks({
            games: g.Games,
            victoryScore: o,
