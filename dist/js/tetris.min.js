var tetris = (() => {
  ...
  var u0 = (r, e, t, o = {}) => {
      ...
      let E = (t / 1e3) * a,
        ...
        X = R + Math.max(E - T, p),
        Q = R + E;
      (f.gain.setValueAtTime(1e-4, R),
        f.gain.linearRampToValueAtTime(i, w),
        f.gain.linearRampToValueAtTime(i * A, X),
        f.gain.exponentialRampToValueAtTime(1e-4, Q),
        l.connect(f),
        f.connect(s.destination),
        l.start(R),
        l.stop(Q + 0.05),
    ...
    L = u0;
  var m0 = (r, e = !1) => (e ? 'perfect' : r === 4 ? 'tetris' : 'combo'),
    Je = class extends q {
      constructor(e) {
        super(e);
      }
      LEVEL_CHANGED = () => {
        L(this, 520, 80, { volume: 0.2, wave: 'triangle' });
      };
      SWITCH_SCENE = () => {
        L(this, 620, 80, { volume: 0.2, wave: 'triangle' });
      };
      DIFFICULTY_CHANGED = () => {
        L(this, 880, 80, { volume: 0.2, wave: 'triangle' });
      };
      GAME_STARTED = () => {
        L(this, 1319, 160, { volume: 0.22, wave: 'triangle' });
      };
      COUNTDOWN = () => {
        L(this, 784, 180, { volume: 0.4, wave: 'sine' });
      };
      MOVE = () => L(this, 330, 60);
      ROTATE = () => L(this, 440, 60);
      DROP = () => L(this, 220, 100);
      FALL = () => L(this, 180, 200);
      CLEAR = (e = 1, t = 1, o = !1) => {
        let s = Math.min(Math.floor((t - 1) / 16), 15),
          ...
          p = i[u].filter((w) => w > 0).map((w) => w + f.shift * 12),
          T = [],
          { Context: A, Scheduler: R } = this;
        for (let [w, X] of p.entries())
          T.push({
            fn: () => {
              let Q = A.currentTime;
              L(this, X, a[w] * f.speed * n.spdMul, {
                volume: d[w] * f.volume * n.volMul,
                wave: n.wave,
                startTime: Q + c[w] / 1e3,
              });
            },
      ...
      LEVEL_UP = () => {
        ...
        t.sequence([
          { fn: () => L(this, 523, 220) },
          { fn: () => L(this, 587, 220, { startTime: o + 0.26 }) },
          { fn: () => L(this, 659, 240, { startTime: o + 0.52 }) },
          { delay: 260, fn: () => L(this, 784, 260, { startTime: o + 0.78 }) },
          { fn: () => L(this, 880, 280, { startTime: o + 1.06 }) },
          { fn: () => L(this, 1047, 320, { startTime: o + 1.36 }) },
          { fn: () => L(this, 1175, 360, { startTime: o + 1.7 }) },
          { fn: () => L(this, 1319, 480, { startTime: o + 2.08 }) },
        ]);
      };
      PAUSED = () => L(this, 300, 150);
      SECOND_TICK = () => {
        L(this, 880, 50, { volume: 0.085, wave: 'triangle' });
      };
      RESUME = () => L(this, 400, 150);
      GAME_OVER = () => {
        let { Context: e, Scheduler: t } = this,
          o = e.currentTime;
        t.sequence([
          { fn: () => L(this, 330, 200) },
          { fn: () => L(this, 294, 300, { startTime: o + 0.21 }) },
          { fn: () => L(this, 262, 500, { startTime: o + 0.52 }) },
        ]);
      };
      BGM_TOGGLED = () => L(this, 440, 100);
    },
    $t = Je;
  var p0 = [
      'SWITCH_CONTROLLER',
    ...
    E0 = [0, 100, 300, 500, 800, 1200],
    q0 = '"Press Start 2P", monospace, sans-serif',
    g0 = 256,
    v0 = {
      CLEAR_LINE_SCORES: E0,
      FONT_FAMILY: q0,
      AI_ALLOWED_ACTIONS: p0,
      MAX_LEVEL: g0,
    },
    x = v0;
  var _0 = {
  ...
  var P0 = {
    ...
    ir = P0;
  var I0 = [Vt, Ft, Wt, Yt, Kt, Xt, Jt, jt, Qt, Zt, er, tr, rr, or, sr, ir],
    je = I0;
  var B0 = 0.12,
    N0 = 25,
    k0 = (r, e, t = {}) => {
      ...
      let l = 0,
        ...
        E = () => {
          let T = c.currentTime + B0;
          for (; f < T; ) {
            let A = e[l];
            u(A, f);
            let R = A.dur * o;
            ((f += R / 1e3), (l = (l + 1) % e.length));
          }
        };
      r.bgmSchedulerId = d.interval(E, N0);
    },
    nr = k0;
  var H0 = (r, e) => {
      let { length: t } = je,
    ...
    U0 = (r, e = 1) => {
      ...
      nr(r, o, { duration: s, volume: i, wave: n, gate: a, articulation: d });
    },
    qe = U0;
  var z0 = (r) => {
  ...
  var $0 = (r, e) => {
    ...
    ar = $0;
  var ae = (r) => ({ CLEAR: `animations:${r}:clear` }),
    _ = () => ({
    ...
    U = (r) => ({ START: `ai:${r}:start`, STOP: `ai:${r}:stop` }),
    de = () => ({
  ...
  var V0 = {
    ...
    lr = V0;
  var F0 = '#00c8ff',
    W0 = 'rgba(0, 200, 255, 0.3)',
    Y0 = '#f1fa04',
    K0 = 'rgba(255, 255, 0, 0.3)',
    X0 = '#d31ac1',
    J0 = 'rgba(211, 26, 193, 0.3)',
    j0 = '#5050ff',
    Q0 = 'rgba(80, 80, 255, 0.3)',
    Z0 = '#ffa500',
    ei = 'rgba(255, 127, 0, 0.3)',
    ti = '#0afa04',
    ri = '#5c9d31',
    oi = 'rgba(0, 255, 0, 0.3)',
    si = '#ff3b30',
    ii = 'rgba(255, 59, 48, 0.3)',
    ni = '#e64a19',
    ai = 'rgba(230, 74, 25, 0.3)',
    di = '#444',
    ci = 'rgba(0, 0, 0, 0.3)',
    li = '#fff',
    fi = 'rgba(255, 255, 255, 0.3)',
    hi = '#ff4fa3',
    ui = 'rgba(255, 79, 163, 0.3)',
    mi = '#7b34eb',
    pi = 'rgba(123, 52, 235, 0.3)',
    Ei = '#0cc0df',
    qi = 'rgba(12, 192, 223, 0.3)',
    gi = '#ff6b6b',
    vi = '#ffa502',
    _i = '#ffd700',
    Si = '#ff7f50',
  ...
  var et = class {
      ...
      setState(e) {
        this.state = { ...this.state, ...(W(e) ? e(this.state) : e) };
      }
      resetState() {
      ...
      generateBoard() {
        let e = { easy: 0, normal: 3, hard: 6, expert: 9 },
          { board: t, difficulty: o } = this.state,
          s = t[0].length,
          i = e[o] || 0;
        return (hr(t, i, s), t);
      }
  ...
  var wn = (r) => {
    ...
    qr = wn;
  var $ = (r, e, t = 0) => (r.textContent = t ? Y(e, t) : String(e)),
    gr = (r, e, t) => {
    ...
    st = class {
      ...
      update(e) {
        ...
        ((o.target = Number(e.score) || 0),
          ...
          e.lines !== i.lines && ($(t.lines, e.lines, 2), (i.lines = e.lines)),
          e.level !== i.level && ($(t.level, e.level, 2), (i.level = e.level)),
          e.combo !== i.combo && ($(t.combo, e.combo, 2), (i.combo = e.combo)));
      }
      updateController(e) {
        $(this.elements.controller, e.toUpperCase());
      }
      tick() {
        let { elements: e, scoreTracker: t, highScoreTracker: o } = this;
        (gr(t, e.score, 5), gr(o, e.highScore, 5));
      }
      reset() {
        let {
          elements: e,
  ...
  var Pn = (r, e) => {
      ...
      (p.save(),
        ...
        (p.font = `${T * a}px ${E}`),
        l &&
          ((p.strokeStyle = n || i), (p.lineWidth = f), p.strokeText(t, o, s)),
        (p.fillStyle = i),
        p.fillText(t, o, s),
        u < 1 && (p.globalAlpha = 1),
        p.restore());
  ...
  var { RGBA_WHITE: _e } = h,
    ...
    K = zn;
  var it = new Map(),
    $n = (r) => `data:image/svg+xml;charset=utf-8,${encodeURIComponent(r)}`,
    D = (r) => {
      let e = it.get(r);
      if (e) return e;
      let t = new Image();
      return ((t.src = $n(r)), it.set(r, t), t);
    },
    Vn = () => {
      it.clear();
    },
  ...
  var Wn = (r, e) => {
      ...
      switch (e) {
        case 'main-menu':
        case 'countdown': {
          ((a = D(K.tetris)), (d = o), (c = o / 2 - d / 2), (l = s - d));
          break;
        }
        case 'playing': {
          (i >= 0 && i <= 8
  ...
  var {
    ...
    S1 = {
      Teal: { stroke: Se, face: a1, secondHand: Te },
      Violet: { stroke: q1, face: g1, secondHand: Se },
      Yellow: { stroke: dt, face: p1, secondHand: Te },
      Pink: { stroke: d1, face: c1, secondHand: dt },
      Purple: { stroke: i1, face: n1, secondHand: Se },
      Green: { stroke: Te, face: h1, secondHand: Se },
      Blue: { stroke: u1, face: m1, secondHand: dt },
      Coral: { stroke: r1, face: o1, secondHand: at },
      Orange: { stroke: l1, face: f1, secondHand: ct },
      Cyan: { stroke: v1, face: _1, secondHand: Te },
      White: { stroke: at, face: s1, secondHand: ct },
      Red: { stroke: ct, face: E1, secondHand: at },
    },
    Le = S1;
  var T1 = (r, e = 'yyyy-MM-dd HH:mm:ss') => {
      let t = r.getFullYear(),
        o = r.getMonth() + 1,
        s = r.getDate(),
        i = r.getHours(),
        ...
        u = e;
      for (let E of Object.keys(f)) u = u.replaceAll(new RegExp(E, 'g'), f[E]);
      return u;
    },
    Mr = T1;
  var L1 = (r) =>
  ...
  var B1 = (r, e, t, o) => {
      let { gameBoardContext: s, blockSize: i } = r,
        ...
        d = e * i + n,
        c = t * i + n;
      ((s.fillStyle = V(o, 0.65)),
        s.fillRect(d, c, a, a),
        (s.strokeStyle = V(o, 0.75)),
        (s.lineWidth = 1),
      ...
      (l.addColorStop(0, V('#FFFFFF', 0.15)),
        l.addColorStop(0.25, V('#FFFFFF', 0)),
        (s.fillStyle = l),
        s.fillRect(d, c, a, a));
      let f = (e * 31 + t * 17 + a * 13) % 1e3;
      for (let u = 0; u < a * a * 0.3; u++) {
        let E = d + ((f + u * 7) % a),
          p = c + ((f + u * 11) % a),
          T = 0.03 + ((f + u * 3) % 8) * 0.01;
        ((s.fillStyle = V('#FFFFFF', T)), s.fillRect(E, p, 1, 1));
      }
      (s.restore(),
  ...
  var N1 = (r, e, t, o) => {
      ...
      ((s.fillStyle = V(o, 0.65)),
        ...
        s.rect(c, l, d, d),
        s.clip());
      let f = s.createLinearGradient(c, l, c, l + d);
      (f.addColorStop(0, V(n, 0.25)),
        f.addColorStop(0.4, V(n, 0)),
        (s.fillStyle = f),
        s.fillRect(c, l, d, d),
        s.restore(),
  ...
  var H1 = (r, e, t, o) => {
      ...
      ((s.fillStyle = y(o, 0.15)),
        s.fillRect(d, c, a, a),
        (s.strokeStyle = h.BLACK),
        (s.lineWidth = 1),
        s.strokeRect(d, c, a, a));
      let l = I(o, 0.25),
        f = Math.max(2, Math.floor(a / 4));
      ((s.fillStyle = l), s.fillRect(d, c, a, f), s.fillRect(d, c, f, a));
    },
    Fr = H1;
  var U1 = (r, e, t, o) => {
      let { RGBA_BLACK: s, RGBA_WHITE: i } = h,
        ...
        u = I(o, 0.15),
        E = y(o, 0.2),
        p = n.createLinearGradient(d, c, d, c + f);
      (p.addColorStop(0, u),
        ...
        n.beginPath(),
        n.moveTo(d, c),
        n.lineTo(d + l * 0.3, c + f * 0.5),
        n.lineTo(d, c + f),
        n.fill(),
        (n.fillStyle = s),
        n.beginPath(),
        n.moveTo(d + l, c),
        n.lineTo(d + l * 0.7, c + f * 0.5),
        n.lineTo(d + l, c + f),
        n.fill(),
        (n.strokeStyle = s),
        (n.lineWidth = 1),
        n.strokeRect(d + 0.5, c + 0.5, l - 1, f - 1));
    },
    Wr = U1;
  var z1 = (r, e, t, o) => {
      let { gameBoardContext: s, blockSize: i } = r,
  ...
  var j = (r) => {
    ...
    Kr = (r) => {
      ...
      (j({ ctx: e, px: t, py: o, w: s, h: i, u: n, steps: 0, color: d }),
        j({ ctx: e, px: t, py: o, w: s, h: i, u: n, steps: 1, color: a }),
        j({ ctx: e, px: t, py: o, w: s, h: i, u: n, steps: 2, color: d }));
    },
    $1 = (r, e, t, o, s = 'square') => {
      ...
      switch (s) {
        case 'jay': {
          (Kr({
            ...
            j({ ctx: i, px: d, py: c, w: l, h: f, u: a, steps: 3, color: E }));
          break;
        }
        case 'ell': {
          (j({ ctx: i, px: d, py: c, w: l, h: f, u: a, steps: 0, color: u }),
            j({ ctx: i, px: d, py: c, w: l, h: f, u: a, steps: 1, color: o }));
          break;
        }
        case 'tee': {
          (j({ ctx: i, px: d, py: c, w: l, h: f, u: a, steps: 0, color: u }),
            j({ ctx: i, px: d, py: c, w: l, h: f, u: a, steps: 1, color: o }),
            (i.fillStyle = E),
            i.fillRect(d + a * 2, c + a * 2, a, f - a * 4),
            i.fillRect(d + a * 2, c + a * 2, l - a * 4, a),
            (i.fillStyle = u),
            i.fillRect(d + a * 2, c + a * 5, l - a * 4, a),
            i.fillRect(d + a * 5, c + a * 3, a, f - a * 6));
          break;
        }
        default:
          Kr({
  ...
  var K1 = {
    ...
    J1 = (r) => {
      let { gameBoard: e } = r,
        ...
        a = X1(s),
        d = K1[a],
        { size: c, x: l, y: f } = d(t, o);
      J(r, { img: n, x: l, y: f, size: c });
    },
    Zr = J1;
  var j1 = (r, e) => {
      let { rows: t, cols: o } = r;
      (O(r), Zr(r), b(r, 'playing'));
      for (let s = 0; s < t; s++)
        for (let i = 0; i < o; i++) e[s][i] && B(r, i, s, e[s][i]);
    },
    eo = j1;
  var Q1 = (r, e, t, o) => {
      let { shape: s, color: i } = e,
        { length: n } = s;
      for (let a = 0; a < n; a++)
        for (let d = 0; d < s[a].length; d++) s[a][d] && B(r, t + d, o + a, i);
      return !0;
    },
    to = Q1;
  var Z1 = (r, e) => {
    ...
    re = Z1;
  var e2 = (r, e) => {
      (O(r), re(r, e), M(r), b(r, 'paused'), G(r), br(r), Ur(r), Gr(r));
    },
    ro = e2;
  var t2 = (r, e) => {
      ro(r, e);
  ...
  var o2 = (r) => {
    ...
    Ce = o2;
  var s2 = (r, e) => {
      (O(r), re(r, e), M(r), b(r, 'game-over'), G(r), Re(r), Ce(r), te(r));
    },
    so = s2;
  var i2 = (r, e) => {
      so(r, e);
  ...
  var a2 = (r, e) => {
      ...
      let { shape: c } = t,
        l = Math.ceil(a / 6),
        f = Math.floor((a - c[0].length * l) / 2),
        u = Math.floor((d - c.length * l) / 2);
      (xe(r), n.save(), n.translate(f, u));
  ...
  var f2 = (r, e) => {
    ...
    no = f2;
  var h2 = (r, e) => {
      (O(r), Me(r, e), M(r), b(r, 'game-over'), G(r), Re(r), Ce(r), te(r));
    },
    ao = h2;
  var u2 = (r, e) => {
      ao(r, e);
  ...
  var q2 = (r, e) => {
      ...
      for (let d = 0; d < n.length; d++)
        for (let c = 0; c < n[d].length; c++) n[d][c] && B(r, s + c, i + d, a);
      t.globalAlpha = 1;
    },
    ho = q2;
  var g2 = (r) => {
  ...
  var v2 = (r, e) => {
      ...
      for (let s of e.lines) {
        ...
        for (let i = 0; i < o; i++) B(r, i, s.y, s.color);
        t.restore();
      }
    },
    mo = v2;
  var _2 = (r, e) => {
      let { WHITE: t, YELLOW: o } = h,
        { gameBoard: s, blockSize: i } = r,
        { width: n } = s,
        { score: a, y: d, alpha: c, offsetY: l, combo: f, comboScore: u } = e;
      if (c <= 0) return;
      let E = n / 2,
        p = d * i + i / 2 - l;
      (f > 1 &&
  ...
  var S2 = (r, e, t = 1) => {
      ...
      (a.save(),
        ...
        (a.lineWidth = 6));
      let f = String(e);
      (a.strokeText(f, 0, 0), a.fillText(f, 0, 0), a.restore());
    },
    Eo = S2;
  var T2 = (r) => {
      let { GREEN: e, BLACK: t } = h,
        { gameBoard: o } = r,
        { width: s, height: i } = o;
      S(r, {
        text: 'GET READY!',
  ...
  var A2 = (r, e) => {
      ...
      (O(r), M(r), G(r), b(r, 'countdown'), go(r), qo(r), Eo(r, t, o));
    },
    vo = A2;
  var R2 = (r, e) => {
      let { gameBoardContext: t } = r;
  ...
  function y2(r, e, t) {
    let { gameBoard: o } = r,
      { height: s } = o;
    (M(r), G(r), So(r), ve(r, e, s / 1.85), To(r), _o(r, t));
  }
  var Lo = y2;
  var O2 = (r, e) => {
      if (!e) return;
  ...
  var lt = class extends q {
      ...
      initialize() {
        ...
        ((this.Hud = new vr({ Hud: i, Player: s })),
          (this.Canvas = new Er({ uuid: e.id, ...n, ...o, ...s })));
      }
      updateMode(e) {
  ...
  var ht = class extends q {
      ...
      initialize(e) {
        let { Game: t } = this;
        ((this.Renderer = new Ro(e)),
          (this.Router = new Co({ UI: this, Game: t })));
      }
      updateMode(e) {
  ...
  var z = {
    ...
    mt = class extends q {
      ...
      _onConnect = (e) => {
        ...
        if (this.boundGamepadIndex !== null) {
          ...
          ((this.activeGamepadIndex = t.index),
            (this.curBtnMap = this._isBetop(t.id) ? be : le));
          let { Game: i } = this,
            n = m(i.id);
          return (
      ...
      _refreshGamepadState() {
        ...
        if (this.boundGamepadIndex !== null)
          return (
            ...
            this.activeGamepad &&
              (this.curBtnMap = this._isBetop(this.activeGamepad.id) ? be : le),
            this
          );
      ...
      _handleStandardButtons(e, t, o, s) {
        let i = this._isBetop(e.id),
          ...
          { Player: d } = n,
          c = a.getController();
        for (let [l, f] of Object.entries(z)) {
          let u =
              !f ||
              ((t === 'replay' || t === 'game-over') && l !== 'START') ||
              (c === 'ai' &&
                t === 'playing' &&
                !x.AI_ALLOWED_ACTIONS.includes(f)) ||
              (n.isVersus() &&
                (l === 'X' ||
                  (d.name === 'ai' && (l === 'Y' || l === 'RT')) ||
                  (d.name === 'human' && l === 'RB'))),
          ...
          if (u) return this;
          let p = this._resolveAction(f, l, E, t, o, s);
          p &&
            this.emit('dispatch:input', {
              device: 'gamepad',
              action: p,
    ...
    we = mt;
  var De = { holes: -5, height: -0.3, bumpiness: -0.2, completeLines: 20 },
    M2 = {
      EASY: { lookahead: 2, noise: 0.15, weights: De, delay: 580 },
      NORMAL: { lookahead: 3, beam: 2, noise: 0.08, weights: De, delay: 480 },
      HARD: { lookahead: 4, beam: 4, noise: 0.04, weights: De, delay: 280 },
      EXPERT: { lookahead: 4, noise: 0, beam: 5, weights: De, delay: 150 },
    },
    oe = M2;
  var b2 = [
      [h.TEAL, h.GREEN, h.ORANGE, h.YELLOW, h.BLUE, h.PINK, h.RED, h.VIOLET],
      [
        h.WARM_TEAL,
        h.WARM_GREEN,
        h.WARM_ORANGE,
  ...
  var U2 = (r, e) => {
    ...
    Uo = U2;
  var z2 = ({ rotationCount: r, targetX: e, originalX: t }) => {
      let o = [];
      return (Ho(o, r), Uo(o, e - t), o.push('DROP'), o);
    },
    zo = z2;
  var $2 = ({
      board: r,
      ...
      let { y: i, placeOn: n } = ko(r, e, t),
        a = zo({ rotationCount: s, targetX: t, originalX: o.position.x });
  ...
  var K2 = (r, e, t) => {
      ...
      for (let T = 0; T < r[0].length; T++) o.push(Fo(r, T));
      let i = o.reduce((T, A) => T + A, 0),
        n = Math.max(...o),
        a = 0;
      for (let T = 0; T < o.length - 1; T++) a += Math.abs(o[T] - o[T + 1]);
      let d = Wo(r),
        c = 0;
  ...
  var Z2 = (r, e) => {
      let { CLEAR_LINE_SCORES: t } = x,
        o = r.filter((A) => A.every((R) => R !== 0)).length,
      ...
      let a = Ie(o, s, i) || t[o] || 0,
        ...
        f = (e.combo || 0) + 1,
        u = f > 1 ? (f - 1) * 50 : 0,
        E = o > 0 && r.every((A) => A.every((R) => R === 0)),
        p = E ? 2e3 : 0,
        T = Math.floor(a * l) + u + p;
      return {
        cleared: o,
        baseScore: a,
        clearScore: T,
    ...
    se = Z2;
  var e5 = (r, e) => {
      let t = Yo(r.board, r.piece.shape, r.piece.position.x, e.y),
        o = ue(t),
        s = se(o, r),
        i = r.bag ? [...r.bag] : [],
        n =
  ...
  var Xo = (r, e, t = 1, o = 5) => {
      ...
      for (let a of s) {
        ...
        (a.actions.includes('HOLD') && (f += 2), f > n && ((n = f), (i = a)));
      }
      return i;
    },
    Jo = Xo;
  ...
  var Lt = class extends q {
      ...
      initialize() {
        ((this.recording = !1),
          ...
          (this.timestamp = 0));
        let { Game: e } = this;
        this.Router = new es({ Replay: this, Game: e });
      }
      getNextPiece() {
      ...
      update({ speed: e, timestamp: t }) {
        ...
        if (d) {
          ...
          if (l > c * 2) {
            let f = Math.min(l - c, 1e3);
            ((this.playElapsed += f), (this.startTime = t - this.playElapsed));
          }
        }
        for (
          ;
  ...
  var o5 = (r, e) => {
    ...
    ss = o5;
  var s5 = (r) => Array.from({ length: r }).fill(0),
    i5 = (r) => {
      let { MAX_LEVEL: e, CLEAR_LINE_SCORES: t, ALL_CLEAR_SCORE: o = 2e3 } = x,
        { Elements: s, Store: i } = r,
        n = i.getState(),
        { cols: a } = s.Canvas,
        d = [...(n.clearLines || [])].toSorted((H, Ye) => Ye - H),
        c = d.length,
        l = structuredClone(n.board);
      for (let H of d) l.splice(H, 1);
      for (let H = 0; H < c; H++) l.unshift(s5(a));
      let f = n.lines + c,
        u = n.baseLines + f,
        { level: E, levelUpSteps: p } = ss(u, e),
        T = E > n.level,
        { isTSpin: A = !1, isTSpinMini: R = !1 } = n.tSpin || {},
        w = Ie(c, A, R),
        X = c >= 4 || A || R,
        Q = X && n.backToBack === !0,
        r0 = Q ? 1.5 : 1,
        o0 = X,
        Bt = c > 0 && l.every((H) => H.every((Ye) => Ye === 0)),
        s0 = Bt ? o : 0,
        i0 = w || t[c] || 0,
        Fe = Math.floor(i0 * r0 * E),
  ...
  var Ct = class extends q {
      ...
      initialize(e) {
        ...
        this.lines = t.map((p) => ({
          y: p,
          alpha: 1,
          color: i.getState().next?.color || h.WHITE,
        }));
  ...
  var yt = class extends q {
      ...
      createFireworks() {
        let { UI: e } = this,
          ...
          s = [h.TEAL, h.YELLOW, h.PURPLE, h.ORANGE, h.GREEN, h.RED, h.PINK],
          i = [];
        for (let n = 0; n < 40; n++) {
  ...
  var d5 = (r) => {
      ...
      (r.emit(i.STOP_RECORD),
        ...
        r.isVersus()
          ? r.emit('battle:update:winner', { loser: r })
          : r.emit(i.GAME_OVER));
    },
    Be = d5;
  var c5 = (r) => {
  ...
  var p5 = (r) => {
      ...
      t === 'main-menu' ||
        ...
        t === 'game-over' ||
        (t === 'playing'
          ? (Ne(r), r.isVersus() && r.emit('battle:sync:pause', { from: r }))
          : (ke(r), r.isVersus() && r.emit('battle:sync:resume', { from: r })));
    },
    hs = p5;
  var E5 = (r, e = 'main-menu') => {
      let { id: t, Store: o } = r,
        s = _(),
        i = U(t),
        n = ae(t),
  ...
  var _5 = (r) => (r === 'I' ? ps : r === 'I5' ? Es : r === 'O' ? null : qs),
    gs = _5;
  var S5 = (r, e) => ((r ?? 0) + e + 4) % 4,
    vs = S5;
  var T5 = (r) => {
      let e = r.length,
        t = r[0].length,
  ...
  var M5 = (r) => {
      ...
      (e.setState({ board: i, tSpin: n }),
        (o._lastAction = null),
        r.isVersus() && r.emit('battle:flush:garbage', { from: r }));
    },
    $e = M5;
  var b5 = (r) => {
  ...
  var B5 = (r) => {
      ...
      } else (e.setState({ hold: { ...i, _held: !0 } }), k(r));
      let d = v(o);
  ...
  var N5 = (r) => {
    ...
    Ms = N5;
  var k5 = (r) => localStorage.getItem(r),
    bs = k5;
  var H5 = (r, e) => {
  ...
  var Gt = class extends q {
      ...
      initialize() {
        let { Elements: e, Block: t, Scheduler: o, Player: s } = this,
          { Controls: i } = e,
          n = new ur({ ...e.Canvas, Player: s, GameState: lr });
        ((this.id =
          crypto?.randomUUID?.() ||
          `${Date.now()}-${Math.random().toString(36).slice(2, 10)}`),
          (this.effect = null),
          (this.Store = n),
          (this.Animations = new pr({ Game: this, Player: s })),
          (this.CommandQueue = new mr({ Game: this, Player: s })),
          (this.UI = new xo({
            Game: this,
            Store: n,
            Elements: e,
        ...
        (((a && s.name === 'ai') || !a) &&
          ...
          (this.Keyboard = new Go({ Game: this, Store: n, Player: s })),
      ...
      selectLevel(e) {
        let t = _();
        (this.Store.setLevel(e),
          this.emit(t.PLAY_SOUND, { sound: 'LEVEL_CHANGED' }));
      }
      switchToDifficulty() {
        let e = _();
      ...
      loadHighScore() {
        let e = Number.parseInt(bs('tetris-high-score'), 10) || 0;
        this.Store.setHighScore(e);
      }
      saveHighScore(e) {
        let { Store: t } = this;
        e > t.getHighScore() &&
          (t.setHighScore(e), ws('tetris-high-score', e.toString()));
      }
      begin() {
        (ls(this),
          this.isVersus() && this.emit('battle:sync:begin', { form: this }));
      }
      start() {
        (fs(this),
          this.isVersus() && this.emit('battle:sync:start', { form: this }));
      }
      pause() {
        Ne(this);
      }
      ...
      startCountdown() {
        let { Scheduler: e } = this;
        this.Animations.register(new rs({ Scheduler: e, Game: this }));
      }
      startPaused() {
        let { Scheduler: e } = this;
        ((this.effect = new os({ Scheduler: e })),
      ...
      startClearLines(e) {
        ...
        (this.isVersus() &&
          this.emit('battle:process:attack', { from: this, lines: e }),
          this.Animations.register(
            new is({ Game: this, Store: o, Scheduler: t, lines: e }),
          ));
      }
      startClearScore(e) {
        let { Scheduler: t } = this;
        this.Animations.register(
          new ns({ Game: this, scoreData: e, Scheduler: t }),
        );
      }
      startLevelUp(e) {
        let { Scheduler: t, UI: o } = this;
        this.Animations.register(
          new as({ Game: this, UI: o, level: e, Scheduler: t }),
        );
      }
      startLandingFlash(e) {
        let { Scheduler: t } = this;
        this.Animations.register(
          new ds({ Game: this, piece: e, Scheduler: t }),
        );
      }
      addEventListeners() {
    ...
    Ds = Gt;
  var U5 = { running: !1, winner: null, scores: {}, pendingGarbage: {} },
    Ps = U5;
  ...
  var bt = class extends q {
      ...
      updateScores(e, t) {
        let { store: o } = this,
          ...
          l = this.getEl(c),
          f = o.getScore(c);
        (n && (n.textContent = a), l && (l.textContent = f));
      }
    },
    Bs = bt;
  ...
  var Dt = class extends q {
    ...
    ks = Dt;
  var z5 = { 1: 0, 2: 1, 3: 2, 4: 3, 5: 4 },
    $5 = { easy: 1, normal: 2, hard: 3, expert: 4 },
    Hs = (r) => z5[r] || 0,
    Us = (r, e, t) => {
      if (e <= 0) return r;
      let o = r[0].length,
      ...
      i.splice(0, e);
      for (let n = 0; n < e; n += 1) {
        let a = Array.from({ length: o }).fill(I(h.BLACK, 0.6)),
          d = new Set();
  ...
  var Pt = class extends q {
      ...
      initialize() {
        let { games: e, elements: t } = this,
          o = new Is({ games: e });
        ((this.store = o),
          (this.hud = new Bs({ games: e, store: o })),
          (this.router = new ks({ battle: this })),
          (this.ui = new Ns({ elements: t })),
          this.start());
      }
      start() {
        let { store: e } = this;
      ...
      processAttack(e, t) {
        ...
        return (n > 0 && i.addGarbage(o, n), n);
      }
      flushGarbage(e) {
        let t = this.store.getPendingGarbage(e);
        if (t <= 0) return;
        let { Store: o } = e,
          { board: s, difficulty: i } = o.getState(),
          n = Us(s, t, i);
        (o.setState({ board: n }), this.store.clearGarbage(e));
      }
      subscribe() {
        this.router.subscribe();
      }
      ...
      tick: (r) => {
        ...
        for (let o of e) {
          ...
          (i.syncPlayElapsed({ timestamp: g.lastTickTime, isBlocked: l }),
            ...
            a?.update?.(),
            c.flush());
          let f = g.gameAccumulators.get(o) || r,
            u = r - f;
          ((!f || u > o.getSpeed()) &&
            !i.playing &&
