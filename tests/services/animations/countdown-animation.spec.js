...
describe('CountdownAnimation', () => {
  ...
  describe('update 方法 - 累加器节奏控制', () => {
    ...
    it('累计 acc 超过 0.01 时应该触发更新', () => {
      ...
      // 第二次 delta=0.006，累计 0.011 > 0.01，触发并重置 acc
      anim.update(0.006);
  ...
  describe('update 方法 - 缩放动画', () => {
    ...
    it('scale 不应该小于 1', () => {
      // scale 初始 = 4，每次减 0.4
      // 4, 3.6, 3.2, 2.8, 2.4, 2.0, 1.6, 1.2, 1.0, 1.0...
      for (let i = 0; i < 15; i++) {
        anim.update(0.01);
      }
